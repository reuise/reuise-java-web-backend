...
import dev.reuise.web.core.topappbar.AbstractWebTopAppBarOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendTopAppBarOptions<S extends AbstractWebBackendTopAppBarOptions<S>> extends AbstractWebTopAppBarOptions<S> implements WebBackendTopAppBarOptions {
    ...
    protected ComponentCreator<? extends CoreIconButton, ? extends CoreIconButtonOptions> navigationButtonCreator;

    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> titleContainerCreator;

    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> actionsContainerCreator;

    protected AbstractWebBackendTopAppBarOptions() {
        this(null);
    }

    protected AbstractWebBackendTopAppBarOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-top-app-bar");
        setTagName("div");
        setHeight(ScreenSizeValues.of(56, 56, 64, 64, 64));
        return true;
    }
    ...
    @Override
    public WebBackendTopAppBar getComponent() {
        return ((WebBackendTopAppBar) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendTopAppBarOptions) (other)) instanceof WebBackendTopAppBarOptions) {
            WebBackendTopAppBarOptions otherWebBackendTopAppBarOptions = ((WebBackendTopAppBarOptions) (other));
            CoreContainerOptions otherContainerOptions = otherWebBackendTopAppBarOptions.getContainerOptions();
            if (otherContainerOptions != null)
                setContainerOptions(otherContainerOptions);

            CoreIconButtonOptions otherNavigationButtonOptions = otherWebBackendTopAppBarOptions.getNavigationButtonOptions();
            if (otherNavigationButtonOptions != null)
                setNavigationButtonOptions(otherNavigationButtonOptions);

            CoreContainerOptions otherTitleContainerOptions = otherWebBackendTopAppBarOptions.getTitleContainerOptions();
            if (otherTitleContainerOptions != null)
                setTitleContainerOptions(otherTitleContainerOptions);

            CoreContainerOptions otherActionsContainerOptions = otherWebBackendTopAppBarOptions.getActionsContainerOptions();
    ...
    public ComponentCreator<? extends CoreIconButton, ? extends CoreIconButtonOptions> getNavigationButtonCreator() {
        return navigationButtonCreator;
    }

    public S setNavigationButtonCreator(ComponentCreator<? extends WebBackendIconButton, ? extends WebBackendIconButtonOptions> navigationButtonCreator) {
        this.navigationButtonCreator = navigationButtonCreator;
        return self();
    }

    protected WebBackendIconButtonOptions createDefaultNavigationButtonOptions() {
        WebBackendIconButtonOptions options = ((WebBackendIconButtonOptions) (super.createDefaultNavigationButtonOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getTitleContainerCreator() {
        return titleContainerCreator;
    }

    public S setTitleContainerCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> titleContainerCreator) {
        this.titleContainerCreator = titleContainerCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultTitleContainerOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultTitleContainerOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getActionsContainerCreator() {
        return actionsContainerCreator;
    }

    public S setActionsContainerCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> actionsContainerCreator) {
        this.actionsContainerCreator = actionsContainerCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultActionsContainerOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultActionsContainerOptions()));
        return options;
    }
}
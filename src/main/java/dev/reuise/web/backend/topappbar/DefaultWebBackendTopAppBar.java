...
import dev.reuise.web.core.topappbar.DefaultWebTopAppBarPart;
...
public abstract class DefaultWebBackendTopAppBar<S extends DefaultWebBackendTopAppBar<S, O>, O extends WebBackendTopAppBarOptions> extends DefaultWebTopAppBarPart<S, O> implements WebBackendComponentType<S, O> , WebBackendTopAppBar {
    ...
    protected DefaultWebBackendTopAppBar(O options) {
        super(options);
    ...
    @Override
    public WebBackendIconButton getNavigationButton() {
        return ((WebBackendIconButton) (super.getNavigationButton()));
    }

    @Override
    public WebBackendContainer getTitleContainer() {
        return ((WebBackendContainer) (super.getTitleContainer()));
    }

    @Override
    public WebBackendContainer getActionsContainer() {
        return ((WebBackendContainer) (super.getActionsContainer()));
    }

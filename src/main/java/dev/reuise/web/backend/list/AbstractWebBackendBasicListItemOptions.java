...
import dev.reuise.web.core.list.AbstractWebBasicListItemOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendBasicListItemOptions<S extends AbstractWebBackendBasicListItemOptions<S>> extends AbstractWebBasicListItemOptions<S> implements WebBackendBasicListItemOptions {
    ...
    protected AbstractWebBackendBasicListItemOptions() {
        this(null);
    }

    protected AbstractWebBackendBasicListItemOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("li");
        setBaseStyleClass("reuise-basiclistitem");
        return true;
    }
    ...
    @Override
    public WebBackendBasicListItem getComponent() {
        return ((WebBackendBasicListItem) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendBasicListItemOptions) (other)) instanceof WebBackendBasicListItemOptions) {
            WebBackendBasicListItemOptions otherWebBackendBasicListItemOptions = ((WebBackendBasicListItemOptions) (other));
            CoreLinkOptions otherLinkOptions = otherWebBackendBasicListItemOptions.getLinkOptions();

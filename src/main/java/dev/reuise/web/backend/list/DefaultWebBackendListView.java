...
import dev.reuise.web.core.list.DefaultWebListViewPart;
...
public abstract class DefaultWebBackendListView<S extends DefaultWebBackendListView<S, O>, O extends WebBackendListViewOptions> extends DefaultWebListViewPart<S, O> implements WebBackendComponentType<S, O> , WebBackendListView {
    ...
    protected DefaultWebBackendListView(O options) {
        super(options);

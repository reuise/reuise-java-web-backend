...
import dev.reuise.web.core.list.AbstractWebBasicListOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendBasicListOptions<S extends AbstractWebBackendBasicListOptions<S>> extends AbstractWebBasicListOptions<S> implements WebBackendBasicListOptions {
    ...
    protected AbstractWebBackendBasicListOptions() {
        this(null);
    }

    protected AbstractWebBackendBasicListOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("ul");
        setBaseStyleClass("reuise-basiclist");
        return true;
    }
    ...
    @Override
    public WebBackendBasicList getComponent() {
        return ((WebBackendBasicList) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendBasicListOptions) (other)) instanceof WebBackendBasicListOptions) {
            WebBackendBasicListOptions otherWebBackendBasicListOptions = ((WebBackendBasicListOptions) (other));
        }
    }
}
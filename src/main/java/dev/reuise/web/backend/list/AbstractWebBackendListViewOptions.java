...
import dev.reuise.web.core.list.AbstractWebListViewOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendListViewOptions<S extends AbstractWebBackendListViewOptions<S>> extends AbstractWebListViewOptions<S> implements WebBackendListViewOptions {
    ...
    protected AbstractWebBackendListViewOptions() {
        this(null);
    }

    protected AbstractWebBackendListViewOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("ul");
        setBaseStyleClass("reuise-listview");
        return true;
    }
    ...
    @Override
    public WebBackendListView getComponent() {
        return ((WebBackendListView) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendListViewOptions) (other)) instanceof WebBackendListViewOptions) {
            WebBackendListViewOptions otherWebBackendListViewOptions = ((WebBackendListViewOptions) (other));
        }
    }
}
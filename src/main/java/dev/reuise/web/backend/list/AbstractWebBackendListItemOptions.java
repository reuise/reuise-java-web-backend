...
import dev.reuise.web.core.list.AbstractWebListItemOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendListItemOptions<S extends AbstractWebBackendListItemOptions<S>> extends AbstractWebListItemOptions<S> implements WebBackendListItemOptions {
    protected final WebBackendBasicListItemPartOptions basicListItemPart;
    ...
    protected ComponentCreator<? extends CoreCheckbox, ? extends CoreCheckboxOptions> checkboxCreator;

    protected ComponentCreator<? extends CoreIcon, ? extends CoreIconOptions> startIconCreator;

    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> textContainerCreator;

    protected ComponentCreator<? extends CoreInlineText, ? extends CoreInlineTextOptions> labelContainerCreator;

    protected ComponentCreator<? extends CoreInlineText, ? extends CoreInlineTextOptions> secondaryLabelContainerCreator;

    protected ComponentCreator<? extends CoreIcon, ? extends CoreIconOptions> endIconCreator;

    protected AbstractWebBackendListItemOptions() {
        this(null);
    }

    protected AbstractWebBackendListItemOptions(WebBackendBasicListItemOptions baseOptions) {
        basicListItemPart = (baseOptions != null) ? baseOptions : getComponentFactory().createBasicListItemOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("li");
        setBaseStyleClass("reuise-listitem");
        return true;
    }
    ...
    public ComponentOption<String> getUrlOption() {
        return basicListItemPart.getUrlOption();
    }
    ...
    @Override
    public CoreLinkOptions getLinkOptions() {
        return basicListItemPart.getLinkOptions();
    }

    @Override
    public S setLinkOptions(CoreLinkOptions linkOptions) {
        this.basicListItemPart.setLinkOptions(linkOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreLink, ? extends CoreLinkOptions> getLinkCreator() {
        return basicListItemPart.getLinkCreator();
    }

    @Override
    public S setLinkCreator(ComponentCreator<? extends WebBackendLink, ? extends WebBackendLinkOptions> linkCreator) {
        this.basicListItemPart.setLinkCreator(linkCreator);
        return self();
    }

    @Override
    public boolean hasLinkOptions() {
        return basicListItemPart.hasLinkOptions();
    }

    public CoreLinkOptions getOrCreateLinkOptions() {
        return basicListItemPart.getOrCreateLinkOptions();
    }

    public WebBackendBasicListItemPartOptions getBasicListItemPart() {
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendListItemOptions) (other)) instanceof WebBackendListItemOptions) {
            WebBackendListItemOptions otherWebBackendListItemOptions = ((WebBackendListItemOptions) (other));
            CoreCheckboxOptions otherCheckboxOptions = otherWebBackendListItemOptions.getCheckboxOptions();
            if (otherCheckboxOptions != null)
                setCheckboxOptions(otherCheckboxOptions);

            CoreIconOptions otherStartIconOptions = otherWebBackendListItemOptions.getStartIconOptions();
            if (otherStartIconOptions != null)
                setStartIconOptions(otherStartIconOptions);

            CoreContainerOptions otherTextContainerOptions = otherWebBackendListItemOptions.getTextContainerOptions();
            if (otherTextContainerOptions != null)
                setTextContainerOptions(otherTextContainerOptions);

            CoreInlineTextOptions otherLabelContainerOptions = otherWebBackendListItemOptions.getLabelContainerOptions();
            if (otherLabelContainerOptions != null)
                setLabelContainerOptions(otherLabelContainerOptions);

            CoreInlineTextOptions otherSecondaryLabelContainerOptions = otherWebBackendListItemOptions.getSecondaryLabelContainerOptions();
            if (otherSecondaryLabelContainerOptions != null)
                setSecondaryLabelContainerOptions(otherSecondaryLabelContainerOptions);

            CoreIconOptions otherEndIconOptions = otherWebBackendListItemOptions.getEndIconOptions();
            if (otherEndIconOptions != null)
                setEndIconOptions(otherEndIconOptions);

        }
    }

    public ComponentCreator<? extends CoreCheckbox, ? extends CoreCheckboxOptions> getCheckboxCreator() {
        return checkboxCreator;
    }

    public S setCheckboxCreator(ComponentCreator<? extends WebBackendCheckbox, ? extends WebBackendCheckboxOptions> checkboxCreator) {
        this.checkboxCreator = checkboxCreator;
        return self();
    }

    protected WebBackendCheckboxOptions createDefaultCheckboxOptions() {
        WebBackendCheckboxOptions options = ((WebBackendCheckboxOptions) (super.createDefaultCheckboxOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreIcon, ? extends CoreIconOptions> getStartIconCreator() {
        return startIconCreator;
    }

    public S setStartIconCreator(ComponentCreator<? extends WebBackendIcon, ? extends WebBackendIconOptions> startIconCreator) {
        this.startIconCreator = startIconCreator;
        return self();
    }

    protected WebBackendIconOptions createDefaultStartIconOptions() {
        WebBackendIconOptions options = ((WebBackendIconOptions) (super.createDefaultStartIconOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getTextContainerCreator() {
        return textContainerCreator;
    }

    public S setTextContainerCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> textContainerCreator) {
        this.textContainerCreator = textContainerCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultTextContainerOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultTextContainerOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreInlineText, ? extends CoreInlineTextOptions> getLabelContainerCreator() {
        return labelContainerCreator;
    }

    public S setLabelContainerCreator(ComponentCreator<? extends WebBackendInlineText, ? extends WebBackendInlineTextOptions> labelContainerCreator) {
        this.labelContainerCreator = labelContainerCreator;
        return self();
    }

    protected WebBackendInlineTextOptions createDefaultLabelContainerOptions() {
        WebBackendInlineTextOptions options = ((WebBackendInlineTextOptions) (super.createDefaultLabelContainerOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreInlineText, ? extends CoreInlineTextOptions> getSecondaryLabelContainerCreator() {
        return secondaryLabelContainerCreator;
    }

    public S setSecondaryLabelContainerCreator(ComponentCreator<? extends WebBackendInlineText, ? extends WebBackendInlineTextOptions> secondaryLabelContainerCreator) {
        this.secondaryLabelContainerCreator = secondaryLabelContainerCreator;
        return self();
    }

    protected WebBackendInlineTextOptions createDefaultSecondaryLabelContainerOptions() {
        WebBackendInlineTextOptions options = ((WebBackendInlineTextOptions) (super.createDefaultSecondaryLabelContainerOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreIcon, ? extends CoreIconOptions> getEndIconCreator() {
        return endIconCreator;
    }

    public S setEndIconCreator(ComponentCreator<? extends WebBackendIcon, ? extends WebBackendIconOptions> endIconCreator) {
        this.endIconCreator = endIconCreator;
        return self();
    }

    protected WebBackendIconOptions createDefaultEndIconOptions() {
        WebBackendIconOptions options = ((WebBackendIconOptions) (super.createDefaultEndIconOptions()));
        return options;
    }
}
...
import dev.reuise.web.core.scrollablecontainer.AbstractWebScrollableContainerScrollAreaOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendScrollableContainerScrollAreaOptions<S extends AbstractWebBackendScrollableContainerScrollAreaOptions<S>> extends AbstractWebScrollableContainerScrollAreaOptions<S> implements WebBackendScrollableContainerScrollAreaOptions {
    ...
    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> scrollAreaTopFadeCreator;

    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> scrollAreaLeftFadeCreator;

    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> scrollAreaContentCreator;

    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> scrollAreaBottomFadeCreator;

    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> scrollAreaRightFadeCreator;

    protected AbstractWebBackendScrollableContainerScrollAreaOptions() {
        this(null);
    }

    protected AbstractWebBackendScrollableContainerScrollAreaOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-scrollablecontainer_scrollarea");
        return true;
    }
    ...
    @Override
    public WebBackendScrollableContainerScrollArea getComponent() {
        return ((WebBackendScrollableContainerScrollArea) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendScrollableContainerScrollAreaOptions) (other)) instanceof WebBackendScrollableContainerScrollAreaOptions) {
            WebBackendScrollableContainerScrollAreaOptions otherWebBackendScrollableContainerScrollAreaOptions = ((WebBackendScrollableContainerScrollAreaOptions) (other));
            CoreContainerOptions otherScrollAreaTopFadeOptions = otherWebBackendScrollableContainerScrollAreaOptions.getScrollAreaTopFadeOptions();
            if (otherScrollAreaTopFadeOptions != null)
                setScrollAreaTopFadeOptions(otherScrollAreaTopFadeOptions);

            CoreContainerOptions otherScrollAreaLeftFadeOptions = otherWebBackendScrollableContainerScrollAreaOptions.getScrollAreaLeftFadeOptions();
            if (otherScrollAreaLeftFadeOptions != null)
                setScrollAreaLeftFadeOptions(otherScrollAreaLeftFadeOptions);

            CoreContainerOptions otherScrollAreaContentOptions = otherWebBackendScrollableContainerScrollAreaOptions.getScrollAreaContentOptions();
            if (otherScrollAreaContentOptions != null)
                setScrollAreaContentOptions(otherScrollAreaContentOptions);

            CoreContainerOptions otherScrollAreaBottomFadeOptions = otherWebBackendScrollableContainerScrollAreaOptions.getScrollAreaBottomFadeOptions();
            if (otherScrollAreaBottomFadeOptions != null)
                setScrollAreaBottomFadeOptions(otherScrollAreaBottomFadeOptions);

            CoreContainerOptions otherScrollAreaRightFadeOptions = otherWebBackendScrollableContainerScrollAreaOptions.getScrollAreaRightFadeOptions();
            if (otherScrollAreaRightFadeOptions != null)
                setScrollAreaRightFadeOptions(otherScrollAreaRightFadeOptions);

        }
    }

    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getScrollAreaTopFadeCreator() {
        return scrollAreaTopFadeCreator;
    }

    public S setScrollAreaTopFadeCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> scrollAreaTopFadeCreator) {
        this.scrollAreaTopFadeCreator = scrollAreaTopFadeCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultScrollAreaTopFadeOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultScrollAreaTopFadeOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getScrollAreaLeftFadeCreator() {
        return scrollAreaLeftFadeCreator;
    }

    public S setScrollAreaLeftFadeCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> scrollAreaLeftFadeCreator) {
        this.scrollAreaLeftFadeCreator = scrollAreaLeftFadeCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultScrollAreaLeftFadeOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultScrollAreaLeftFadeOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getScrollAreaContentCreator() {
        return scrollAreaContentCreator;
    }

    public S setScrollAreaContentCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> scrollAreaContentCreator) {
        this.scrollAreaContentCreator = scrollAreaContentCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultScrollAreaContentOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultScrollAreaContentOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getScrollAreaBottomFadeCreator() {
        return scrollAreaBottomFadeCreator;
    }

    public S setScrollAreaBottomFadeCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> scrollAreaBottomFadeCreator) {
        this.scrollAreaBottomFadeCreator = scrollAreaBottomFadeCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultScrollAreaBottomFadeOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultScrollAreaBottomFadeOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getScrollAreaRightFadeCreator() {
        return scrollAreaRightFadeCreator;
    }

    public S setScrollAreaRightFadeCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> scrollAreaRightFadeCreator) {
        this.scrollAreaRightFadeCreator = scrollAreaRightFadeCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultScrollAreaRightFadeOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultScrollAreaRightFadeOptions()));
        return options;
    }
}
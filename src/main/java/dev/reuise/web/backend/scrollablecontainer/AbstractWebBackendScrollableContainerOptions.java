...
import dev.reuise.web.core.scrollablecontainer.AbstractWebScrollableContainerOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendScrollableContainerOptions<S extends AbstractWebBackendScrollableContainerOptions<S>> extends AbstractWebScrollableContainerOptions<S> implements WebBackendScrollableContainerOptions {
    ...
    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> scrollAreaBeforeCreator;

    protected ComponentCreator<? extends CoreScrollableContainerScrollArea, ? extends CoreScrollableContainerScrollAreaOptions> scrollAreaCreator;

    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> scrollAreaAfterCreator;

    protected AbstractWebBackendScrollableContainerOptions() {
        this(null);
    }

    protected AbstractWebBackendScrollableContainerOptions(WebBackendContainerOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-scrollablecontainer");
        setStoreInElementOptions(new ArrayList(Arrays.asList("scrollDirection")));
        return true;
    }
    ...
    @Override
    public WebBackendScrollableContainer getComponent() {
        return ((WebBackendScrollableContainer) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendScrollableContainerOptions) (other)) instanceof WebBackendScrollableContainerOptions) {
            WebBackendScrollableContainerOptions otherWebBackendScrollableContainerOptions = ((WebBackendScrollableContainerOptions) (other));
            CoreContainerOptions otherScrollAreaBeforeOptions = otherWebBackendScrollableContainerOptions.getScrollAreaBeforeOptions();
            if (otherScrollAreaBeforeOptions != null)
                setScrollAreaBeforeOptions(otherScrollAreaBeforeOptions);

            CoreScrollableContainerScrollAreaOptions otherScrollAreaOptions = otherWebBackendScrollableContainerOptions.getScrollAreaOptions();
            if (otherScrollAreaOptions != null)
                setScrollAreaOptions(otherScrollAreaOptions);

            CoreContainerOptions otherScrollAreaAfterOptions = otherWebBackendScrollableContainerOptions.getScrollAreaAfterOptions();
            if (otherScrollAreaAfterOptions != null)
                setScrollAreaAfterOptions(otherScrollAreaAfterOptions);

        }
    }

    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getScrollAreaBeforeCreator() {
        return scrollAreaBeforeCreator;
    }

    public S setScrollAreaBeforeCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> scrollAreaBeforeCreator) {
        this.scrollAreaBeforeCreator = scrollAreaBeforeCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultScrollAreaBeforeOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultScrollAreaBeforeOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreScrollableContainerScrollArea, ? extends CoreScrollableContainerScrollAreaOptions> getScrollAreaCreator() {
        return scrollAreaCreator;
    }

    public S setScrollAreaCreator(ComponentCreator<? extends WebBackendScrollableContainerScrollArea, ? extends WebBackendScrollableContainerScrollAreaOptions> scrollAreaCreator) {
        this.scrollAreaCreator = scrollAreaCreator;
        return self();
    }

    protected WebBackendScrollableContainerScrollAreaOptions createDefaultScrollAreaOptions() {
        WebBackendScrollableContainerScrollAreaOptions options = ((WebBackendScrollableContainerScrollAreaOptions) (super.createDefaultScrollAreaOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getScrollAreaAfterCreator() {
        return scrollAreaAfterCreator;
    }

    public S setScrollAreaAfterCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> scrollAreaAfterCreator) {
        this.scrollAreaAfterCreator = scrollAreaAfterCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultScrollAreaAfterOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultScrollAreaAfterOptions()));
        return options;
    }
}
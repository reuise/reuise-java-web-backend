...
import dev.reuise.web.core.scrollablecontainer.DefaultWebScrollableContainerEdgePart;
...
public abstract class DefaultWebBackendScrollableContainerEdge<S extends DefaultWebBackendScrollableContainerEdge<S, O>, O extends WebBackendScrollableContainerEdgeOptions> extends DefaultWebScrollableContainerEdgePart<S, O> implements WebBackendScrollableContainerEdge , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendScrollableContainerEdge(O options) {
        super(options);

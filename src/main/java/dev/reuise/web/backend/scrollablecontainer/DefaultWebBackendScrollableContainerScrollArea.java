...
import dev.reuise.web.core.scrollablecontainer.DefaultWebScrollableContainerScrollAreaPart;
...
public abstract class DefaultWebBackendScrollableContainerScrollArea<S extends DefaultWebBackendScrollableContainerScrollArea<S, O>, O extends WebBackendScrollableContainerScrollAreaOptions> extends DefaultWebScrollableContainerScrollAreaPart<S, O> implements WebBackendScrollableContainerScrollArea , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendScrollableContainerScrollArea(O options) {
        super(options);
    ...
    @Override
    public WebBackendContainer getScrollAreaTopFade() {
        return ((WebBackendContainer) (super.getScrollAreaTopFade()));
    }

    @Override
    public WebBackendContainer getScrollAreaLeftFade() {
        return ((WebBackendContainer) (super.getScrollAreaLeftFade()));
    }

    @Override
    public WebBackendContainer getScrollAreaContent() {
        return ((WebBackendContainer) (super.getScrollAreaContent()));
    }

    @Override
    public WebBackendContainer getScrollAreaBottomFade() {
        return ((WebBackendContainer) (super.getScrollAreaBottomFade()));
    }

    @Override
    public WebBackendContainer getScrollAreaRightFade() {
        return ((WebBackendContainer) (super.getScrollAreaRightFade()));
    }

...
import dev.reuise.web.core.scrollablecontainer.AbstractWebScrollableContainerEdgeOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendScrollableContainerEdgeOptions<S extends AbstractWebBackendScrollableContainerEdgeOptions<S>> extends AbstractWebScrollableContainerEdgeOptions<S> implements WebBackendScrollableContainerEdgeOptions {
    ...
    protected AbstractWebBackendScrollableContainerEdgeOptions() {
        this(null);
    }

    protected AbstractWebBackendScrollableContainerEdgeOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-scrollablecontainer_edge");
        return true;
    }
    ...
    @Override
    public WebBackendScrollableContainerEdge getComponent() {
        return ((WebBackendScrollableContainerEdge) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendScrollableContainerEdgeOptions) (other)) instanceof WebBackendScrollableContainerEdgeOptions) {
            WebBackendScrollableContainerEdgeOptions otherWebBackendScrollableContainerEdgeOptions = ((WebBackendScrollableContainerEdgeOptions) (other));
        }
    }
}
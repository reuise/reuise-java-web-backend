...
import dev.reuise.web.core.scrollablecontainer.DefaultWebScrollableContainerPart;
...
public abstract class DefaultWebBackendScrollableContainer<S extends DefaultWebBackendScrollableContainer<S, O>, O extends WebBackendScrollableContainerOptions> extends DefaultWebScrollableContainerPart<S, O> implements WebBackendComponentType<S, O> , WebBackendScrollableContainer {
    ...
    protected DefaultWebBackendScrollableContainer(O options) {
        super(options);
    ...
    @Override
    public WebBackendContainer getScrollAreaBefore() {
        return ((WebBackendContainer) (super.getScrollAreaBefore()));
    }

    @Override
    public WebBackendScrollableContainerScrollArea getScrollArea() {
        return ((WebBackendScrollableContainerScrollArea) (super.getScrollArea()));
    }

    @Override
    public WebBackendContainer getScrollAreaAfter() {
        return ((WebBackendContainer) (super.getScrollAreaAfter()));
    }

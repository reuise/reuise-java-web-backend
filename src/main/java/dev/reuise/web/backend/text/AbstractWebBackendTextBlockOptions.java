...
import dev.reuise.web.core.text.AbstractWebTextBlockOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendTextBlockOptions<S extends AbstractWebBackendTextBlockOptions<S>> extends AbstractWebTextBlockOptions<S> implements WebBackendTextBlockOptions {
    protected final WebBackendTextPartOptions textPart;
    ...
    protected AbstractWebBackendTextBlockOptions() {
        this(null);
    }

    protected AbstractWebBackendTextBlockOptions(WebBackendTextOptions baseOptions) {
        textPart = (baseOptions != null) ? baseOptions : getComponentFactory().createTextOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-textblock");
        return true;
    }
    ...
    public ComponentOption<String> getTextOption() {
        return textPart.getTextOption();
    }

    @Override
    public S setText(String text) {
        this.textPart.setText(text);
        return self();
    }

    @Override
    public Object getFontSize() {
        return textPart.getFontSize();
    }

    @Override
    public ComponentOption<Object> getFontSizeOption() {
        return textPart.getFontSizeOption();
    }

    @Override
    public S setFontSize(Object fontSize) {
        this.textPart.setFontSize(fontSize);
        return self();
    }

    @Override
    public S setFontSize(Object fontSize, State state) {
        this.textPart.setFontSize(fontSize, state);
        return self();
    }

    @Override
    public S setFontSizeAllStates(Object fontSize) {
        setFontSize(ScreenSizeValues.of(fontSize, fontSize));
        setFontSize(fontSize);
        return self();
    }

    @Override
    public S setFontSize(ScreenSizeValues<Object> fontSize) {
        this.textPart.setFontSize(fontSize);
        return self();
    }
    ...
    public Object getFontSize(State state) {
        return textPart.getFontSize(state);
    }

    @Override
    public ComponentOption<Object> getFontSizeOption(State state) {
        return textPart.getFontSizeOption(state);
    }

    @Override
    public Collection<State> getFontSizeStates() {
        return textPart.getFontSizeStates();
    }

    @Override
    public Object getLineHeight() {
        return textPart.getLineHeight();
    }

    @Override
    public ComponentOption<Object> getLineHeightOption() {
        return textPart.getLineHeightOption();
    }

    @Override
    public S setLineHeight(Object lineHeight) {
        this.textPart.setLineHeight(lineHeight);
        return self();
    }

    @Override
    public S setLineHeight(Object lineHeight, State state) {
        this.textPart.setLineHeight(lineHeight, state);
        return self();
    }

    @Override
    public S setLineHeightAllStates(Object lineHeight) {
        setLineHeight(ScreenSizeValues.of(lineHeight, lineHeight));
        setLineHeight(lineHeight);
        return self();
    }

    @Override
    public S setLineHeight(ScreenSizeValues<Object> lineHeight) {
        this.textPart.setLineHeight(lineHeight);
        return self();
    }
    ...
    public Object getLineHeight(State state) {
        return textPart.getLineHeight(state);
    }

    @Override
    public ComponentOption<Object> getLineHeightOption(State state) {
        return textPart.getLineHeightOption(state);
    }

    @Override
    public Collection<State> getLineHeightStates() {
        return textPart.getLineHeightStates();
    }
    ...
    public ComponentOption<String> getHighlightTextOption() {
        return textPart.getHighlightTextOption();
    }
    ...
    public WebBackendTextPartOptions getTextPart() {
        return textPart;
    }
    ...
    @Override
    public WebBackendTextBlock getComponent() {
        return ((WebBackendTextBlock) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendTextBlockOptions) (other)) instanceof WebBackendTextBlockOptions) {
            WebBackendTextBlockOptions otherWebBackendTextBlockOptions = ((WebBackendTextBlockOptions) (other));
        }
    }
}
...
import dev.reuise.web.core.text.AbstractWebLabelOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendLabelOptions<S extends AbstractWebBackendLabelOptions<S>> extends AbstractWebLabelOptions<S> implements WebBackendLabelOptions {
    protected final WebBackendInlineTextPartOptions inlineTextPart;
    ...
    protected AbstractWebBackendLabelOptions() {
        this(null);
    }

    protected AbstractWebBackendLabelOptions(WebBackendInlineTextOptions baseOptions) {
        inlineTextPart = (baseOptions != null) ? baseOptions : getComponentFactory().createInlineTextOptions();
    ...
    public WebBackendInlineTextPartOptions getInlineTextPart() {
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendLabelOptions) (other)) instanceof WebBackendLabelOptions) {
            WebBackendLabelOptions otherWebBackendLabelOptions = ((WebBackendLabelOptions) (other));
        }
    }
}
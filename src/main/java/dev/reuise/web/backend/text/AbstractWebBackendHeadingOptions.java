...
import dev.reuise.web.core.text.AbstractWebHeadingOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendHeadingOptions<S extends AbstractWebBackendHeadingOptions<S>> extends AbstractWebHeadingOptions<S> implements WebBackendHeadingOptions {
    ...
    protected AbstractWebBackendHeadingOptions() {
        this(null);
    }

    protected AbstractWebBackendHeadingOptions(WebBackendTextOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("h1");
        setBaseStyleClass("reuise-heading");
        return true;
    }
    ...
    @Override
    public WebBackendHeading getComponent() {
        return ((WebBackendHeading) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendHeadingOptions) (other)) instanceof WebBackendHeadingOptions) {
            WebBackendHeadingOptions otherWebBackendHeadingOptions = ((WebBackendHeadingOptions) (other));
        }
    }
}
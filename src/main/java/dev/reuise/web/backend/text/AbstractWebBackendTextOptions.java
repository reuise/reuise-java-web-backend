...
import dev.reuise.web.core.text.AbstractWebTextOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendTextOptions<S extends AbstractWebBackendTextOptions<S>> extends AbstractWebTextOptions<S> implements WebBackendTextOptions {
    ...
    protected AbstractWebBackendTextOptions() {
        this(null);
    }

    protected AbstractWebBackendTextOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    @Override
    public WebBackendText getComponent() {
        return ((WebBackendText) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendTextOptions) (other)) instanceof WebBackendTextOptions) {
            WebBackendTextOptions otherWebBackendTextOptions = ((WebBackendTextOptions) (other));
        }
    }
}
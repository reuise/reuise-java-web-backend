...
import dev.reuise.web.core.text.DefaultWebTextPart;
...
public abstract class DefaultWebBackendText<S extends DefaultWebBackendText<S, O>, O extends WebBackendTextOptions> extends DefaultWebTextPart<S, O> implements WebBackendComponentType<S, O> , WebBackendText {
    ...
    protected DefaultWebBackendText(O options) {
        super(options);

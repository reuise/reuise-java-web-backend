...
import dev.reuise.web.core.text.AbstractWebParagraphOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendParagraphOptions<S extends AbstractWebBackendParagraphOptions<S>> extends AbstractWebParagraphOptions<S> implements WebBackendParagraphOptions {
    ...
    protected AbstractWebBackendParagraphOptions() {
        this(null);
    }

    protected AbstractWebBackendParagraphOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("p");
        setBaseStyleClass("reuise-paragraph");
        return true;
    }
    ...
    @Override
    public WebBackendParagraph getComponent() {
        return ((WebBackendParagraph) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendParagraphOptions) (other)) instanceof WebBackendParagraphOptions) {
            WebBackendParagraphOptions otherWebBackendParagraphOptions = ((WebBackendParagraphOptions) (other));
        }
    }
}
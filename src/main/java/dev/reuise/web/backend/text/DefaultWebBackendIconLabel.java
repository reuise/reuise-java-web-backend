...
import dev.reuise.web.core.text.DefaultWebIconLabelPart;
...
public abstract class DefaultWebBackendIconLabel<S extends DefaultWebBackendIconLabel<S, O>, O extends WebBackendIconLabelOptions> extends DefaultWebIconLabelPart<S, O> implements WebBackendComponentType<S, O> , WebBackendIconLabel {
    ...
    protected DefaultWebBackendIconLabel(O options) {
        super(options);

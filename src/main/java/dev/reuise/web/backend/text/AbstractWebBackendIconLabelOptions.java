...
import dev.reuise.web.core.text.AbstractWebIconLabelOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendIconLabelOptions<S extends AbstractWebBackendIconLabelOptions<S>> extends AbstractWebIconLabelOptions<S> implements WebBackendIconLabelOptions {
    ...
    protected ComponentCreator<? extends CoreLink, ? extends CoreLinkOptions> linkCreator;
    ...
    protected AbstractWebBackendIconLabelOptions() {
        this(null);
    }

    protected AbstractWebBackendIconLabelOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("label");
        setBaseStyleClass("reuise-iconlabel");
        return true;
    }
    ...
    @Override
    public WebBackendIconLabel getComponent() {
        return ((WebBackendIconLabel) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendIconLabelOptions) (other)) instanceof WebBackendIconLabelOptions) {
            WebBackendIconLabelOptions otherWebBackendIconLabelOptions = ((WebBackendIconLabelOptions) (other));
            CoreLinkOptions otherLinkOptions = otherWebBackendIconLabelOptions.getLinkOptions();
            if (otherLinkOptions != null)
                setLinkOptions(otherLinkOptions);

            CoreIconOptions otherStartIconOptions = otherWebBackendIconLabelOptions.getStartIconOptions();
            if (otherStartIconOptions != null)
                setStartIconOptions(otherStartIconOptions);

            CoreInlineTextOptions otherLabelContainerOptions = otherWebBackendIconLabelOptions.getLabelContainerOptions();
            if (otherLabelContainerOptions != null)
                setLabelContainerOptions(otherLabelContainerOptions);

            CoreIconOptions otherEndIconOptions = otherWebBackendIconLabelOptions.getEndIconOptions();
    ...
    protected WebBackendLinkOptions createDefaultLinkOptions() {
        WebBackendLinkOptions options = ((WebBackendLinkOptions) (super.createDefaultLinkOptions()));
        return options;
    }

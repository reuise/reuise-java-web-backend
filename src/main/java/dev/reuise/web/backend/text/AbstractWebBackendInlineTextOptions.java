...
import dev.reuise.web.core.text.AbstractWebInlineTextOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendInlineTextOptions<S extends AbstractWebBackendInlineTextOptions<S>> extends AbstractWebInlineTextOptions<S> implements WebBackendInlineTextOptions {
    ...
    protected AbstractWebBackendInlineTextOptions() {
        this(null);
    }

    protected AbstractWebBackendInlineTextOptions(WebBackendTextOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("span");
        setBaseStyleClass("reuise-inlinetext");
        return true;
    }
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendInlineTextOptions) (other)) instanceof WebBackendInlineTextOptions) {
            WebBackendInlineTextOptions otherWebBackendInlineTextOptions = ((WebBackendInlineTextOptions) (other));
        }
    }
}
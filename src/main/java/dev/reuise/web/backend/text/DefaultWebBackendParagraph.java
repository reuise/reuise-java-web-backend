...
import dev.reuise.web.core.text.DefaultWebParagraphPart;
...
public abstract class DefaultWebBackendParagraph<S extends DefaultWebBackendParagraph<S, O>, O extends WebBackendParagraphOptions> extends DefaultWebParagraphPart<S, O> implements WebBackendComponentType<S, O> , WebBackendParagraph {
    ...
    protected DefaultWebBackendParagraph(O options) {
        super(options);

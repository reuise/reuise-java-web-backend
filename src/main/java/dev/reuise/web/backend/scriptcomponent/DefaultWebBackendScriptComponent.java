...
import dev.reuise.web.core.scriptcomponent.DefaultWebScriptComponentPart;
...
public abstract class DefaultWebBackendScriptComponent<S extends DefaultWebBackendScriptComponent<S, O>, O extends WebBackendScriptComponentOptions> extends DefaultWebScriptComponentPart<S, O> implements WebBackendScriptComponent , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendScriptComponent(O options) {
        super(options);
    ...
    public void writeTo(PrintWriter writer) {
        boolean hasCode = (this.code != null) && (!this.code.isEmpty());

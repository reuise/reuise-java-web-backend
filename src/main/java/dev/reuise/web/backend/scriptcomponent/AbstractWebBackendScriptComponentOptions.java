...
import dev.reuise.web.core.scriptcomponent.AbstractWebScriptComponentOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendScriptComponentOptions<S extends AbstractWebBackendScriptComponentOptions<S>> extends AbstractWebScriptComponentOptions<S> implements WebBackendScriptComponentOptions {
    ...
    protected AbstractWebBackendScriptComponentOptions() {
        this(null);
    }

    protected AbstractWebBackendScriptComponentOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("script");
        setBaseStyleClass("reuise-scriptcomponent");
        return true;
    }
    ...
    @Override
    public WebBackendScriptComponent getComponent() {
        return ((WebBackendScriptComponent) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendScriptComponentOptions) (other)) instanceof WebBackendScriptComponentOptions) {
            WebBackendScriptComponentOptions otherWebBackendScriptComponentOptions = ((WebBackendScriptComponentOptions) (other));
        }
    }
}
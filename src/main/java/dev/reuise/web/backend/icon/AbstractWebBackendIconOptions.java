...
import dev.reuise.web.core.icon.AbstractWebIconOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendIconOptions<S extends AbstractWebBackendIconOptions<S>> extends AbstractWebIconOptions<S> implements WebBackendIconOptions {
    ...
    protected ComponentCreator<? extends WebSvg, ? extends WebSvgOptions> svgCreator;
    ...
    protected AbstractWebBackendIconOptions() {
        this(null);
    }

    protected AbstractWebBackendIconOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    @Override
    public WebBackendIcon getComponent() {
        return ((WebBackendIcon) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendIconOptions) (other)) instanceof WebBackendIconOptions) {
            WebBackendIconOptions otherWebBackendIconOptions = ((WebBackendIconOptions) (other));
            WebSvgOptions otherSvgOptions = otherWebBackendIconOptions.getSvgOptions();
            if (otherSvgOptions != null)
                setSvgOptions(otherSvgOptions);

            CoreLinkOptions otherLinkOptions = otherWebBackendIconOptions.getLinkOptions();
            if (otherLinkOptions != null)
                setLinkOptions(otherLinkOptions);

            CoreImageOptions otherImageOptions = otherWebBackendIconOptions.getImageOptions();
    ...
    public ComponentCreator<? extends WebSvg, ? extends WebSvgOptions> getSvgCreator() {
        return svgCreator;
    }

    public S setSvgCreator(ComponentCreator<? extends WebBackendSvg, ? extends WebBackendSvgOptions> svgCreator) {
        this.svgCreator = svgCreator;
        return self();
    }

    protected WebBackendSvgOptions createDefaultSvgOptions() {
        WebBackendSvgOptions options = ((WebBackendSvgOptions) (super.createDefaultSvgOptions()));
        return options;
    }

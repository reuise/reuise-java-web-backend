...
import dev.reuise.web.core.icon.DefaultWebIconPart;
...
public abstract class DefaultWebBackendIcon<S extends DefaultWebBackendIcon<S, O>, O extends WebBackendIconOptions> extends DefaultWebIconPart<S, O> implements WebBackendComponentType<S, O> , WebBackendIcon {
    ...
    protected DefaultWebBackendIcon(O options) {
        super(options);
    ...
    @Override
    public WebBackendSvg getSvg() {
        return ((WebBackendSvg) (super.getSvg()));
    }

...
import dev.reuise.web.core.table.DefaultWebTableCellPart;
...
public abstract class DefaultWebBackendTableCell<S extends DefaultWebBackendTableCell<S, O>, O extends WebBackendTableCellOptions> extends DefaultWebTableCellPart<S, O> implements WebBackendComponentType<S, O> , WebBackendTableCell {
    ...
    protected DefaultWebBackendTableCell(O options) {
        super(options);

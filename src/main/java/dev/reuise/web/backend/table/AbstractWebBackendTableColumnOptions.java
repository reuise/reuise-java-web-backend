...
import dev.reuise.web.core.table.AbstractWebTableColumnOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendTableColumnOptions<S extends AbstractWebBackendTableColumnOptions<S>> extends AbstractWebTableColumnOptions<S> implements WebBackendTableColumnOptions {
    ...
    protected AbstractWebBackendTableColumnOptions() {
        this(null);
    }

    protected AbstractWebBackendTableColumnOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("col");
        setBaseStyleClass("reuise-table_column");
        return true;
    }
    ...
    @Override
    public WebBackendTableColumn getComponent() {
        return ((WebBackendTableColumn) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendTableColumnOptions) (other)) instanceof WebBackendTableColumnOptions) {
            WebBackendTableColumnOptions otherWebBackendTableColumnOptions = ((WebBackendTableColumnOptions) (other));
        }
    }
}
...
import dev.reuise.web.core.table.AbstractWebTableFooterOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendTableFooterOptions<S extends AbstractWebBackendTableFooterOptions<S>> extends AbstractWebTableFooterOptions<S> implements WebBackendTableFooterOptions {
    ...
    protected AbstractWebBackendTableFooterOptions() {
        this(null);
    }

    protected AbstractWebBackendTableFooterOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("tfoot");
        setBaseStyleClass("reuise-table_footer");
        return true;
    }
    ...
    @Override
    public WebBackendTableFooter getComponent() {
        return ((WebBackendTableFooter) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendTableFooterOptions) (other)) instanceof WebBackendTableFooterOptions) {
            WebBackendTableFooterOptions otherWebBackendTableFooterOptions = ((WebBackendTableFooterOptions) (other));
        }
    }
}
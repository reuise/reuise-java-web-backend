...
import dev.reuise.web.core.table.AbstractWebTableColumnGroupOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendTableColumnGroupOptions<S extends AbstractWebBackendTableColumnGroupOptions<S>> extends AbstractWebTableColumnGroupOptions<S> implements WebBackendTableColumnGroupOptions {
    ...
    protected AbstractWebBackendTableColumnGroupOptions() {
        this(null);
    }

    protected AbstractWebBackendTableColumnGroupOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("colgroup");
        setBaseStyleClass("reuise-table_columngroup");
        return true;
    }
    ...
    @Override
    public WebBackendTableColumnGroup getComponent() {
        return ((WebBackendTableColumnGroup) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendTableColumnGroupOptions) (other)) instanceof WebBackendTableColumnGroupOptions) {
            WebBackendTableColumnGroupOptions otherWebBackendTableColumnGroupOptions = ((WebBackendTableColumnGroupOptions) (other));
        }
    }
}
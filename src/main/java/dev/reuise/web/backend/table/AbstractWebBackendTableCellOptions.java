...
import dev.reuise.web.core.table.AbstractWebTableCellOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendTableCellOptions<S extends AbstractWebBackendTableCellOptions<S>> extends AbstractWebTableCellOptions<S> implements WebBackendTableCellOptions {
    ...
    protected AbstractWebBackendTableCellOptions() {
        this(null);
    }

    protected AbstractWebBackendTableCellOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("td");
        setBaseStyleClass("reuise-table_cell");
        return true;
    }
    ...
    @Override
    public WebBackendTableCell getComponent() {
        return ((WebBackendTableCell) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendTableCellOptions) (other)) instanceof WebBackendTableCellOptions) {
            WebBackendTableCellOptions otherWebBackendTableCellOptions = ((WebBackendTableCellOptions) (other));
        }
    }
}
...
import dev.reuise.web.core.table.DefaultWebTableHeaderPart;
...
public abstract class DefaultWebBackendTableHeader<S extends DefaultWebBackendTableHeader<S, O>, O extends WebBackendTableHeaderOptions> extends DefaultWebTableHeaderPart<S, O> implements WebBackendComponentType<S, O> , WebBackendTableHeader {
    ...
    protected DefaultWebBackendTableHeader(O options) {
        super(options);
    ...
    @Override
    public WebBackendTableHeaderRow getRow() {
        return ((WebBackendTableHeaderRow) (super.getRow()));
    }

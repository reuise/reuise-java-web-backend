...
import dev.reuise.web.core.table.AbstractWebTableRowOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendTableRowOptions<S extends AbstractWebBackendTableRowOptions<S>> extends AbstractWebTableRowOptions<S> implements WebBackendTableRowOptions {
    ...
    protected AbstractWebBackendTableRowOptions() {
        this(null);
    }

    protected AbstractWebBackendTableRowOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("tr");
        setBaseStyleClass("reuise-table_row");
        return true;
    }
    ...
    @Override
    public WebBackendTableRow getComponent() {
        return ((WebBackendTableRow) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendTableRowOptions) (other)) instanceof WebBackendTableRowOptions) {
            WebBackendTableRowOptions otherWebBackendTableRowOptions = ((WebBackendTableRowOptions) (other));
        }
    }
}
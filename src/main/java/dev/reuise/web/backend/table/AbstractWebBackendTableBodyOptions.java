...
import dev.reuise.web.core.table.AbstractWebTableBodyOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendTableBodyOptions<S extends AbstractWebBackendTableBodyOptions<S>> extends AbstractWebTableBodyOptions<S> implements WebBackendTableBodyOptions {
    ...
    protected AbstractWebBackendTableBodyOptions() {
        this(null);
    }

    protected AbstractWebBackendTableBodyOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("tbody");
        setBaseStyleClass("reuise-table_body");
        return true;
    }
    ...
    @Override
    public WebBackendTableBody getComponent() {
        return ((WebBackendTableBody) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendTableBodyOptions) (other)) instanceof WebBackendTableBodyOptions) {
            WebBackendTableBodyOptions otherWebBackendTableBodyOptions = ((WebBackendTableBodyOptions) (other));
        }
    }
}
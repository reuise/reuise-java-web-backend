...
import dev.reuise.web.core.table.AbstractWebTableOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendTableOptions<S extends AbstractWebBackendTableOptions<S>> extends AbstractWebTableOptions<S> implements WebBackendTableOptions {
    ...
    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> tableCreator;

    protected ComponentCreator<? extends CoreTableColumnGroup, ? extends CoreTableColumnGroupOptions> columnGroupCreator;

    protected ComponentCreator<? extends CoreTableHeader, ? extends CoreTableHeaderOptions> headerCreator;

    protected ComponentCreator<? extends CoreTableBody, ? extends CoreTableBodyOptions> bodyCreator;

    protected ComponentCreator<? extends CoreTableFooter, ? extends CoreTableFooterOptions> footerCreator;

    protected AbstractWebBackendTableOptions() {
        this(null);
    }

    protected AbstractWebBackendTableOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-table");
        return true;
    }
    ...
    @Override
    public WebBackendTable getComponent() {
        return ((WebBackendTable) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendTableOptions) (other)) instanceof WebBackendTableOptions) {
            WebBackendTableOptions otherWebBackendTableOptions = ((WebBackendTableOptions) (other));
            CoreContainerOptions otherTableOptions = otherWebBackendTableOptions.getTableOptions();
            if (otherTableOptions != null)
                setTableOptions(otherTableOptions);

            CoreTableColumnGroupOptions otherColumnGroupOptions = otherWebBackendTableOptions.getColumnGroupOptions();
            if (otherColumnGroupOptions != null)
                setColumnGroupOptions(otherColumnGroupOptions);

            CoreTableHeaderOptions otherHeaderOptions = otherWebBackendTableOptions.getHeaderOptions();
            if (otherHeaderOptions != null)
                setHeaderOptions(otherHeaderOptions);

            CoreTableBodyOptions otherBodyOptions = otherWebBackendTableOptions.getBodyOptions();
            if (otherBodyOptions != null)
                setBodyOptions(otherBodyOptions);

            CoreTableFooterOptions otherFooterOptions = otherWebBackendTableOptions.getFooterOptions();
    ...
    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getTableCreator() {
        return tableCreator;
    }

    public S setTableCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> tableCreator) {
        this.tableCreator = tableCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultTableOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultTableOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreTableColumnGroup, ? extends CoreTableColumnGroupOptions> getColumnGroupCreator() {
        return columnGroupCreator;
    }

    public S setColumnGroupCreator(ComponentCreator<? extends WebBackendTableColumnGroup, ? extends WebBackendTableColumnGroupOptions> columnGroupCreator) {
        this.columnGroupCreator = columnGroupCreator;
        return self();
    }

    protected WebBackendTableColumnGroupOptions createDefaultColumnGroupOptions() {
        WebBackendTableColumnGroupOptions options = ((WebBackendTableColumnGroupOptions) (super.createDefaultColumnGroupOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreTableHeader, ? extends CoreTableHeaderOptions> getHeaderCreator() {
        return headerCreator;
    }

    public S setHeaderCreator(ComponentCreator<? extends WebBackendTableHeader, ? extends WebBackendTableHeaderOptions> headerCreator) {
        this.headerCreator = headerCreator;
        return self();
    }

    protected WebBackendTableHeaderOptions createDefaultHeaderOptions() {
        WebBackendTableHeaderOptions options = ((WebBackendTableHeaderOptions) (super.createDefaultHeaderOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreTableBody, ? extends CoreTableBodyOptions> getBodyCreator() {
        return bodyCreator;
    }

    public S setBodyCreator(ComponentCreator<? extends WebBackendTableBody, ? extends WebBackendTableBodyOptions> bodyCreator) {
        this.bodyCreator = bodyCreator;
        return self();
    }

    protected WebBackendTableBodyOptions createDefaultBodyOptions() {
        WebBackendTableBodyOptions options = ((WebBackendTableBodyOptions) (super.createDefaultBodyOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreTableFooter, ? extends CoreTableFooterOptions> getFooterCreator() {
        return footerCreator;
    }

    public S setFooterCreator(ComponentCreator<? extends WebBackendTableFooter, ? extends WebBackendTableFooterOptions> footerCreator) {
        this.footerCreator = footerCreator;
        return self();
    }

    protected WebBackendTableFooterOptions createDefaultFooterOptions() {
        WebBackendTableFooterOptions options = ((WebBackendTableFooterOptions) (super.createDefaultFooterOptions()));
        return options;
    }
}
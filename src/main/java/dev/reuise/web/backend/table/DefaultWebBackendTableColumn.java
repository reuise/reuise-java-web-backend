...
import dev.reuise.web.core.table.DefaultWebTableColumnPart;
...
public abstract class DefaultWebBackendTableColumn<S extends DefaultWebBackendTableColumn<S, O>, O extends WebBackendTableColumnOptions> extends DefaultWebTableColumnPart<S, O> implements WebBackendComponentType<S, O> , WebBackendTableColumn {
    ...
    protected DefaultWebBackendTableColumn(O options) {
        super(options);

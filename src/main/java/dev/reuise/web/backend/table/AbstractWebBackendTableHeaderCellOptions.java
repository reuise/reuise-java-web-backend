...
import dev.reuise.web.core.table.AbstractWebTableHeaderCellOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendTableHeaderCellOptions<S extends AbstractWebBackendTableHeaderCellOptions<S>> extends AbstractWebTableHeaderCellOptions<S> implements WebBackendTableHeaderCellOptions {
    ...
    protected ComponentCreator<? extends CoreMenu, ? extends CoreMenuOptions> menuCreator;

    protected ComponentCreator<? extends CoreIconButton, ? extends CoreIconButtonOptions> menuButtonCreator;

    protected AbstractWebBackendTableHeaderCellOptions() {
        this(null);
    }

    protected AbstractWebBackendTableHeaderCellOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("th");
        setBaseStyleClass("reuise-table_headercell");
        return true;
    }
    ...
    @Override
    public WebBackendTableHeaderCell getComponent() {
        return ((WebBackendTableHeaderCell) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendTableHeaderCellOptions) (other)) instanceof WebBackendTableHeaderCellOptions) {
            WebBackendTableHeaderCellOptions otherWebBackendTableHeaderCellOptions = ((WebBackendTableHeaderCellOptions) (other));
            CoreInlineTextOptions otherLabelContainerOptions = otherWebBackendTableHeaderCellOptions.getLabelContainerOptions();
            if (otherLabelContainerOptions != null)
                setLabelContainerOptions(otherLabelContainerOptions);

            CoreMenuOptions otherMenuOptions = otherWebBackendTableHeaderCellOptions.getMenuOptions();
            if (otherMenuOptions != null)
                setMenuOptions(otherMenuOptions);

            CoreIconButtonOptions otherMenuButtonOptions = otherWebBackendTableHeaderCellOptions.getMenuButtonOptions();
            if (otherMenuButtonOptions != null)
                setMenuButtonOptions(otherMenuButtonOptions);
    ...
    public ComponentCreator<? extends CoreMenu, ? extends CoreMenuOptions> getMenuCreator() {
        return menuCreator;
    }

    public S setMenuCreator(ComponentCreator<? extends WebBackendMenu, ? extends WebBackendMenuOptions> menuCreator) {
        this.menuCreator = menuCreator;
        return self();
    }

    protected WebBackendMenuOptions createDefaultMenuOptions() {
        WebBackendMenuOptions options = ((WebBackendMenuOptions) (super.createDefaultMenuOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreIconButton, ? extends CoreIconButtonOptions> getMenuButtonCreator() {
        return menuButtonCreator;
    }

    public S setMenuButtonCreator(ComponentCreator<? extends WebBackendIconButton, ? extends WebBackendIconButtonOptions> menuButtonCreator) {
        this.menuButtonCreator = menuButtonCreator;
        return self();
    }

    protected WebBackendIconButtonOptions createDefaultMenuButtonOptions() {
        WebBackendIconButtonOptions options = ((WebBackendIconButtonOptions) (super.createDefaultMenuButtonOptions()));
        return options;
    }
}
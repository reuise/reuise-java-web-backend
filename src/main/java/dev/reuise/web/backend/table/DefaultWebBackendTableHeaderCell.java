...
import dev.reuise.web.core.table.DefaultWebTableHeaderCellPart;
...
public abstract class DefaultWebBackendTableHeaderCell<S extends DefaultWebBackendTableHeaderCell<S, O>, O extends WebBackendTableHeaderCellOptions> extends DefaultWebTableHeaderCellPart<S, O> implements WebBackendComponentType<S, O> , WebBackendTableHeaderCell {
    ...
    protected DefaultWebBackendTableHeaderCell(O options) {
        super(options);
    ...
    @Override
    public WebBackendMenu getMenu() {
        return ((WebBackendMenu) (super.getMenu()));
    }

    @Override
    public WebBackendIconButton getMenuButton() {
        return ((WebBackendIconButton) (super.getMenuButton()));
    }

...
import dev.reuise.web.core.table.DefaultWebTablePart;
...
public abstract class DefaultWebBackendTable<S extends DefaultWebBackendTable<S, O>, O extends WebBackendTableOptions> extends DefaultWebTablePart<S, O> implements WebBackendComponentType<S, O> , WebBackendTable {
    ...
    protected DefaultWebBackendTable(O options) {
        super(options);
    ...
    @Override
    public WebBackendContainer getTable() {
        return ((WebBackendContainer) (super.getTable()));
    }

    @Override
    public WebBackendTableColumnGroup getColumnGroup() {
        return ((WebBackendTableColumnGroup) (super.getColumnGroup()));
    }

    @Override
    public WebBackendTableHeader getHeader() {
        return ((WebBackendTableHeader) (super.getHeader()));
    }

    @Override
    public WebBackendTableBody getBody() {
        return ((WebBackendTableBody) (super.getBody()));
    }

    @Override
    public WebBackendTableFooter getFooter() {
        return ((WebBackendTableFooter) (super.getFooter()));
    }

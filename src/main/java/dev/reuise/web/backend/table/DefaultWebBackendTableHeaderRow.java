...
import dev.reuise.web.core.table.DefaultWebTableHeaderRowPart;
...
public abstract class DefaultWebBackendTableHeaderRow<S extends DefaultWebBackendTableHeaderRow<S, O>, O extends WebBackendTableHeaderRowOptions> extends DefaultWebTableHeaderRowPart<S, O> implements WebBackendComponentType<S, O> , WebBackendTableHeaderRow {
    ...
    protected DefaultWebBackendTableHeaderRow(O options) {
        super(options);

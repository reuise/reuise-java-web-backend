...
import dev.reuise.web.core.table.DefaultWebTableColumnGroupPart;
...
public abstract class DefaultWebBackendTableColumnGroup<S extends DefaultWebBackendTableColumnGroup<S, O>, O extends WebBackendTableColumnGroupOptions> extends DefaultWebTableColumnGroupPart<S, O> implements WebBackendTableColumnGroup , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendTableColumnGroup(O options) {
        super(options);

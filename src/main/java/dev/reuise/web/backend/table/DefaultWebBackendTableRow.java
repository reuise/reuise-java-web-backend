...
import dev.reuise.web.core.table.DefaultWebTableRowPart;
...
public abstract class DefaultWebBackendTableRow<S extends DefaultWebBackendTableRow<S, O>, O extends WebBackendTableRowOptions> extends DefaultWebTableRowPart<S, O> implements WebBackendTableRow , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendTableRow(O options) {
        super(options);

...
import dev.reuise.web.core.table.AbstractWebCheckboxTableCellOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendCheckboxTableCellOptions<S extends AbstractWebBackendCheckboxTableCellOptions<S>> extends AbstractWebCheckboxTableCellOptions<S> implements WebBackendCheckboxTableCellOptions {
    protected final WebBackendTableCellPartOptions tableCellPart;
    ...
    protected AbstractWebBackendCheckboxTableCellOptions() {
        this(null);
    }

    protected AbstractWebBackendCheckboxTableCellOptions(WebBackendTableCellOptions baseOptions) {
        tableCellPart = (baseOptions != null) ? baseOptions : getComponentFactory().createTableCellOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setStyleClass("reuise-table_checkboxcell");
        return true;
    }
    ...
    public String getText() {
        return tableCellPart.getText();
    }

    @Override
    public ComponentOption<String> getTextOption() {
        return tableCellPart.getTextOption();
    }

    @Override
    public S setText(String text) {
        this.tableCellPart.setText(text);
        return self();
    }

    public WebBackendTableCellPartOptions getTableCellPart() {
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendCheckboxTableCellOptions) (other)) instanceof WebBackendCheckboxTableCellOptions) {
            WebBackendCheckboxTableCellOptions otherWebBackendCheckboxTableCellOptions = ((WebBackendCheckboxTableCellOptions) (other));
            CoreCheckboxOptions otherCheckboxOptions = otherWebBackendCheckboxTableCellOptions.getCheckboxOptions();

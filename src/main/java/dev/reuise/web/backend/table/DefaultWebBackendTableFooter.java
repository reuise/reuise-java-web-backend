...
import dev.reuise.web.core.table.DefaultWebTableFooterPart;
...
public abstract class DefaultWebBackendTableFooter<S extends DefaultWebBackendTableFooter<S, O>, O extends WebBackendTableFooterOptions> extends DefaultWebTableFooterPart<S, O> implements WebBackendComponentType<S, O> , WebBackendTableFooter {
    ...
    protected DefaultWebBackendTableFooter(O options) {
        super(options);

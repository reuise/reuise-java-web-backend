...
import dev.reuise.web.core.table.AbstractWebTableHeaderRowOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendTableHeaderRowOptions<S extends AbstractWebBackendTableHeaderRowOptions<S>> extends AbstractWebTableHeaderRowOptions<S> implements WebBackendTableHeaderRowOptions {
    ...
    protected AbstractWebBackendTableHeaderRowOptions() {
        this(null);
    }

    protected AbstractWebBackendTableHeaderRowOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("tr");
        setBaseStyleClass("reuise-table_headerrow");
        return true;
    }
    ...
    @Override
    public WebBackendTableHeaderRow getComponent() {
        return ((WebBackendTableHeaderRow) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendTableHeaderRowOptions) (other)) instanceof WebBackendTableHeaderRowOptions) {
            WebBackendTableHeaderRowOptions otherWebBackendTableHeaderRowOptions = ((WebBackendTableHeaderRowOptions) (other));
        }
    }
}
...
import dev.reuise.web.core.table.DefaultWebTableBodyPart;
...
public abstract class DefaultWebBackendTableBody<S extends DefaultWebBackendTableBody<S, O>, O extends WebBackendTableBodyOptions> extends DefaultWebTableBodyPart<S, O> implements WebBackendComponentType<S, O> , WebBackendTableBody {
    ...
    protected DefaultWebBackendTableBody(O options) {
        super(options);

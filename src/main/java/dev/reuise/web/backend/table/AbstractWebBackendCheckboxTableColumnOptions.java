...
import dev.reuise.web.core.table.AbstractWebCheckboxTableColumnOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendCheckboxTableColumnOptions<S extends AbstractWebBackendCheckboxTableColumnOptions<S>> extends AbstractWebCheckboxTableColumnOptions<S> implements WebBackendCheckboxTableColumnOptions {
    protected final WebBackendTableColumnPartOptions tableColumnPart;
    ...
    protected AbstractWebBackendCheckboxTableColumnOptions() {
        this(null);
    }

    protected AbstractWebBackendCheckboxTableColumnOptions(WebBackendTableColumnOptions baseOptions) {
        tableColumnPart = (baseOptions != null) ? baseOptions : getComponentFactory().createTableColumnOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-table_checkboxcolumn");
        return true;
    }
    ...
    public String getLabel() {
        return tableColumnPart.getLabel();
    }

    @Override
    public ComponentOption<String> getLabelOption() {
        return tableColumnPart.getLabelOption();
    }

    @Override
    public S setLabel(String label) {
        this.tableColumnPart.setLabel(label);
        return self();
    }

    @Override
    public CoreMenuOptions getMenuOptions() {
        return tableColumnPart.getMenuOptions();
    }

    @Override
    public ComponentOption<CoreMenuOptions> getMenuOptionsOption() {
        return tableColumnPart.getMenuOptionsOption();
    }

    @Override
    public S setMenuOptions(CoreMenuOptions menuOptions) {
        this.tableColumnPart.setMenuOptions(menuOptions);
        return self();
    }

    @Override
    public boolean isHasMenuButton() {
        return tableColumnPart.isHasMenuButton();
    }

    @Override
    public ComponentOption<Boolean> getHasMenuButtonOption() {
        return tableColumnPart.getHasMenuButtonOption();
    }

    @Override
    public S setHasMenuButton(Boolean hasMenuButton) {
        this.tableColumnPart.setHasMenuButton(hasMenuButton);
        return self();
    }

    @Override
    public CoreIconButtonOptions getMenuButtonOptions() {
        return tableColumnPart.getMenuButtonOptions();
    }

    @Override
    public ComponentOption<CoreIconButtonOptions> getMenuButtonOptionsOption() {
        return tableColumnPart.getMenuButtonOptionsOption();
    }

    @Override
    public S setMenuButtonOptions(CoreIconButtonOptions menuButtonOptions) {
        this.tableColumnPart.setMenuButtonOptions(menuButtonOptions);
        return self();
    }

    public WebBackendTableColumnPartOptions getTableColumnPart() {
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendCheckboxTableColumnOptions) (other)) instanceof WebBackendCheckboxTableColumnOptions) {
            WebBackendCheckboxTableColumnOptions otherWebBackendCheckboxTableColumnOptions = ((WebBackendCheckboxTableColumnOptions) (other));
            CoreCheckboxOptions otherCheckboxOptions = otherWebBackendCheckboxTableColumnOptions.getCheckboxOptions();

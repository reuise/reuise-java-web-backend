...
import dev.reuise.web.core.card.AbstractWebCardGridOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendCardGridOptions<S extends AbstractWebBackendCardGridOptions<S>> extends AbstractWebCardGridOptions<S> implements WebBackendCardGridOptions {
    ...
    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> cardContainerCreator;

    protected AbstractWebBackendCardGridOptions() {
        this(null);
    }

    protected AbstractWebBackendCardGridOptions(WebBackendContainerOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-cardgrid");
        setStoreInElementOptions(new ArrayList(Arrays.asList("columnGap", "rowGap", "cardWidth", "cardHeight", "positionMode", "animation", "expandableCards")));
        return true;
    }
    ...
    @Override
    public WebBackendCardGrid getComponent() {
        return ((WebBackendCardGrid) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendCardGridOptions) (other)) instanceof WebBackendCardGridOptions) {
            WebBackendCardGridOptions otherWebBackendCardGridOptions = ((WebBackendCardGridOptions) (other));
            CoreContainerOptions otherScrimOptions = otherWebBackendCardGridOptions.getScrimOptions();
            if (otherScrimOptions != null)
                setScrimOptions(otherScrimOptions);

            CoreContainerOptions otherCardContainerOptions = otherWebBackendCardGridOptions.getCardContainerOptions();
            if (otherCardContainerOptions != null)
                setCardContainerOptions(otherCardContainerOptions);
    ...
    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getCardContainerCreator() {
        return cardContainerCreator;
    }

    public S setCardContainerCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> cardContainerCreator) {
        this.cardContainerCreator = cardContainerCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultCardContainerOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultCardContainerOptions()));
        return options;
    }
}
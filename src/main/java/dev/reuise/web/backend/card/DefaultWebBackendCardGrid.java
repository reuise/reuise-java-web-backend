...
import dev.reuise.web.core.card.DefaultWebCardGridPart;
...
public abstract class DefaultWebBackendCardGrid<S extends DefaultWebBackendCardGrid<S, O>, O extends WebBackendCardGridOptions> extends DefaultWebCardGridPart<S, O> implements WebBackendCardGrid , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendCardGrid(O options) {
        super(options);
    ...
    @Override
    public WebBackendContainer getCardContainer() {
        return ((WebBackendContainer) (super.getCardContainer()));
    }

...
import dev.reuise.web.core.card.AbstractWebCardOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendCardOptions<S extends AbstractWebBackendCardOptions<S>> extends AbstractWebCardOptions<S> implements WebBackendCardOptions {
    protected final WebBackendSurfacePartOptions surfacePart;

    protected final WebBackendFlexContainerPartOptions flexContainerPart;
    ...
    protected ComponentCreator<? extends CoreLink, ? extends CoreLinkOptions> mediaLinkCreator;

    protected ComponentCreator<? extends CoreFlexContainer, ? extends CoreFlexContainerOptions> mediaContainerCreator;

    protected ComponentCreator<? extends CoreImage, ? extends CoreImageOptions> imageCreator;

    protected ComponentCreator<? extends CoreFlexContainer, ? extends CoreFlexContainerOptions> textContentCreator;

    protected ComponentCreator<? extends CoreFlexContainer, ? extends CoreFlexContainerOptions> headlineCreator;

    protected ComponentCreator<? extends CoreLink, ? extends CoreLinkOptions> headingLinkCreator;

    protected ComponentCreator<? extends CoreTextBlock, ? extends CoreTextBlockOptions> headingContainerCreator;

    protected ComponentCreator<? extends CoreTextBlock, ? extends CoreTextBlockOptions> subHeadingContainerCreator;

    protected ComponentCreator<? extends CoreTextBlock, ? extends CoreTextBlockOptions> textContainerCreator;

    protected ComponentCreator<? extends CoreFlexContainer, ? extends CoreFlexContainerOptions> actionsContainerCreator;

    protected AbstractWebBackendCardOptions() {
        this(null);
    }

    protected AbstractWebBackendCardOptions(WebBackendSurfaceOptions baseOptions) {
        surfacePart = (baseOptions != null) ? baseOptions : getComponentFactory().createSurfaceOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-card");
        setDirection(((FlexDirection) (null)));
        return true;
    }
    ...
    public ComponentOption<SurfaceType> getTypeOption() {
        return surfacePart.getTypeOption();
    }
    ...
    public WebBackendSurfacePartOptions getSurfacePart() {
        return surfacePart;
    }
    ...
    public ComponentOption<FlexDirection> getDirectionOption() {
        return flexContainerPart.getDirectionOption();
    }
    ...
    public ComponentOption<FlexDirection> getDirectionOption(State state) {
        return flexContainerPart.getDirectionOption(state);
    }

    @Override
    public Collection<State> getDirectionStates() {
        return flexContainerPart.getDirectionStates();
    }
    ...
    public ComponentOption<JustifyContent> getJustifyContentOption() {
        return flexContainerPart.getJustifyContentOption();
    }
    ...
    public ComponentOption<JustifyContent> getJustifyContentOption(State state) {
        return flexContainerPart.getJustifyContentOption(state);
    }

    @Override
    public Collection<State> getJustifyContentStates() {
        return flexContainerPart.getJustifyContentStates();
    }
    ...
    public ComponentOption<AlignItems> getAlignItemsOption() {
        return flexContainerPart.getAlignItemsOption();
    }
    ...
    public ComponentOption<AlignItems> getAlignItemsOption(State state) {
        return flexContainerPart.getAlignItemsOption(state);
    }

    @Override
    public Collection<State> getAlignItemsStates() {
        return flexContainerPart.getAlignItemsStates();
    }
    ...
    public ComponentOption<Object> getColumnGapOption() {
        return flexContainerPart.getColumnGapOption();
    }
    ...
    public ComponentOption<Object> getColumnGapOption(State state) {
        return flexContainerPart.getColumnGapOption(state);
    }

    @Override
    public Collection<State> getColumnGapStates() {
        return flexContainerPart.getColumnGapStates();
    }
    ...
    public ComponentOption<Object> getRowGapOption() {
        return flexContainerPart.getRowGapOption();
    }
    ...
    public ComponentOption<Object> getRowGapOption(State state) {
        return flexContainerPart.getRowGapOption(state);
    }

    @Override
    public Collection<State> getRowGapStates() {
        return flexContainerPart.getRowGapStates();
    }
    ...
    public ComponentOption<Object> getGapOption() {
        return flexContainerPart.getGapOption();
    }
    ...
    public ComponentOption<Object> getGapOption(State state) {
        return flexContainerPart.getGapOption(state);
    }

    @Override
    public Collection<State> getGapStates() {
        return flexContainerPart.getGapStates();
    }
    ...
    public ComponentOption<Boolean> getWrapOption() {
        return flexContainerPart.getWrapOption();
    }
    ...
    public ComponentOption<Boolean> getWrapOption(State state) {
        return flexContainerPart.getWrapOption(state);
    }

    @Override
    public Collection<State> getWrapStates() {
        return flexContainerPart.getWrapStates();
    }

    public boolean isWrapAnyState() {
        return flexContainerPart.isWrapAnyState();
    }

    public WebBackendFlexContainerPartOptions getFlexContainerPart() {
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendCardOptions) (other)) instanceof WebBackendCardOptions) {
            WebBackendCardOptions otherWebBackendCardOptions = ((WebBackendCardOptions) (other));
            CoreLinkOptions otherMediaLinkOptions = otherWebBackendCardOptions.getMediaLinkOptions();
            if (otherMediaLinkOptions != null)
                setMediaLinkOptions(otherMediaLinkOptions);

            CoreFlexContainerOptions otherMediaContainerOptions = otherWebBackendCardOptions.getMediaContainerOptions();
            if (otherMediaContainerOptions != null)
                setMediaContainerOptions(otherMediaContainerOptions);

            CoreImageOptions otherImageOptions = otherWebBackendCardOptions.getImageOptions();
            if (otherImageOptions != null)
                setImageOptions(otherImageOptions);

            CoreFlexContainerOptions otherTextContentOptions = otherWebBackendCardOptions.getTextContentOptions();
            if (otherTextContentOptions != null)
                setTextContentOptions(otherTextContentOptions);

            CoreFlexContainerOptions otherHeadlineOptions = otherWebBackendCardOptions.getHeadlineOptions();
            if (otherHeadlineOptions != null)
                setHeadlineOptions(otherHeadlineOptions);

            CoreLinkOptions otherHeadingLinkOptions = otherWebBackendCardOptions.getHeadingLinkOptions();
            if (otherHeadingLinkOptions != null)
                setHeadingLinkOptions(otherHeadingLinkOptions);

            CoreTextBlockOptions otherHeadingContainerOptions = otherWebBackendCardOptions.getHeadingContainerOptions();
            if (otherHeadingContainerOptions != null)
                setHeadingContainerOptions(otherHeadingContainerOptions);

            CoreTextBlockOptions otherSubHeadingContainerOptions = otherWebBackendCardOptions.getSubHeadingContainerOptions();
            if (otherSubHeadingContainerOptions != null)
                setSubHeadingContainerOptions(otherSubHeadingContainerOptions);

            CoreTextBlockOptions otherTextContainerOptions = otherWebBackendCardOptions.getTextContainerOptions();
            if (otherTextContainerOptions != null)
                setTextContainerOptions(otherTextContainerOptions);

            CoreFlexContainerOptions otherActionsContainerOptions = otherWebBackendCardOptions.getActionsContainerOptions();
            if (otherActionsContainerOptions != null)
                setActionsContainerOptions(otherActionsContainerOptions);

        }
    }

    public ComponentCreator<? extends CoreLink, ? extends CoreLinkOptions> getMediaLinkCreator() {
        return mediaLinkCreator;
    }

    public S setMediaLinkCreator(ComponentCreator<? extends WebBackendLink, ? extends WebBackendLinkOptions> mediaLinkCreator) {
        this.mediaLinkCreator = mediaLinkCreator;
        return self();
    }

    protected WebBackendLinkOptions createDefaultMediaLinkOptions() {
        WebBackendLinkOptions options = ((WebBackendLinkOptions) (super.createDefaultMediaLinkOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreFlexContainer, ? extends CoreFlexContainerOptions> getMediaContainerCreator() {
        return mediaContainerCreator;
    }

    public S setMediaContainerCreator(ComponentCreator<? extends WebBackendFlexContainer, ? extends WebBackendFlexContainerOptions> mediaContainerCreator) {
        this.mediaContainerCreator = mediaContainerCreator;
        return self();
    }

    protected WebBackendFlexContainerOptions createDefaultMediaContainerOptions() {
        WebBackendFlexContainerOptions options = ((WebBackendFlexContainerOptions) (super.createDefaultMediaContainerOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreImage, ? extends CoreImageOptions> getImageCreator() {
        return imageCreator;
    }

    public S setImageCreator(ComponentCreator<? extends WebBackendImage, ? extends WebBackendImageOptions> imageCreator) {
        this.imageCreator = imageCreator;
        return self();
    }

    protected WebBackendImageOptions createDefaultImageOptions() {
        WebBackendImageOptions options = ((WebBackendImageOptions) (super.createDefaultImageOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreFlexContainer, ? extends CoreFlexContainerOptions> getTextContentCreator() {
        return textContentCreator;
    }

    public S setTextContentCreator(ComponentCreator<? extends WebBackendFlexContainer, ? extends WebBackendFlexContainerOptions> textContentCreator) {
        this.textContentCreator = textContentCreator;
        return self();
    }

    protected WebBackendFlexContainerOptions createDefaultTextContentOptions() {
        WebBackendFlexContainerOptions options = ((WebBackendFlexContainerOptions) (super.createDefaultTextContentOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreFlexContainer, ? extends CoreFlexContainerOptions> getHeadlineCreator() {
        return headlineCreator;
    }

    public S setHeadlineCreator(ComponentCreator<? extends WebBackendFlexContainer, ? extends WebBackendFlexContainerOptions> headlineCreator) {
        this.headlineCreator = headlineCreator;
        return self();
    }

    protected WebBackendFlexContainerOptions createDefaultHeadlineOptions() {
        WebBackendFlexContainerOptions options = ((WebBackendFlexContainerOptions) (super.createDefaultHeadlineOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreLink, ? extends CoreLinkOptions> getHeadingLinkCreator() {
        return headingLinkCreator;
    }

    public S setHeadingLinkCreator(ComponentCreator<? extends WebBackendLink, ? extends WebBackendLinkOptions> headingLinkCreator) {
        this.headingLinkCreator = headingLinkCreator;
        return self();
    }

    protected WebBackendLinkOptions createDefaultHeadingLinkOptions() {
        WebBackendLinkOptions options = ((WebBackendLinkOptions) (super.createDefaultHeadingLinkOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreTextBlock, ? extends CoreTextBlockOptions> getHeadingContainerCreator() {
        return headingContainerCreator;
    }

    public S setHeadingContainerCreator(ComponentCreator<? extends WebBackendTextBlock, ? extends WebBackendTextBlockOptions> headingContainerCreator) {
        this.headingContainerCreator = headingContainerCreator;
        return self();
    }

    protected WebBackendTextBlockOptions createDefaultHeadingContainerOptions() {
        WebBackendTextBlockOptions options = ((WebBackendTextBlockOptions) (super.createDefaultHeadingContainerOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreTextBlock, ? extends CoreTextBlockOptions> getSubHeadingContainerCreator() {
        return subHeadingContainerCreator;
    }

    public S setSubHeadingContainerCreator(ComponentCreator<? extends WebBackendTextBlock, ? extends WebBackendTextBlockOptions> subHeadingContainerCreator) {
        this.subHeadingContainerCreator = subHeadingContainerCreator;
        return self();
    }

    protected WebBackendTextBlockOptions createDefaultSubHeadingContainerOptions() {
        WebBackendTextBlockOptions options = ((WebBackendTextBlockOptions) (super.createDefaultSubHeadingContainerOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreTextBlock, ? extends CoreTextBlockOptions> getTextContainerCreator() {
        return textContainerCreator;
    }

    public S setTextContainerCreator(ComponentCreator<? extends WebBackendTextBlock, ? extends WebBackendTextBlockOptions> textContainerCreator) {
        this.textContainerCreator = textContainerCreator;
        return self();
    }

    protected WebBackendTextBlockOptions createDefaultTextContainerOptions() {
        WebBackendTextBlockOptions options = ((WebBackendTextBlockOptions) (super.createDefaultTextContainerOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreFlexContainer, ? extends CoreFlexContainerOptions> getActionsContainerCreator() {
        return actionsContainerCreator;
    }

    public S setActionsContainerCreator(ComponentCreator<? extends WebBackendFlexContainer, ? extends WebBackendFlexContainerOptions> actionsContainerCreator) {
        this.actionsContainerCreator = actionsContainerCreator;
        return self();
    }

    protected WebBackendFlexContainerOptions createDefaultActionsContainerOptions() {
        WebBackendFlexContainerOptions options = ((WebBackendFlexContainerOptions) (super.createDefaultActionsContainerOptions()));
        return options;
    }
}
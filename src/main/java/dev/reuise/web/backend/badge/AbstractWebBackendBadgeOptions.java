...
import dev.reuise.web.core.badge.AbstractWebBadgeOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendBadgeOptions<S extends AbstractWebBackendBadgeOptions<S>> extends AbstractWebBadgeOptions<S> implements WebBackendBadgeOptions {
    protected final WebBackendBaseComponentPartOptions baseComponentPart;

    protected AbstractWebBackendBadgeOptions() {
        this(null);
    }

    protected AbstractWebBackendBadgeOptions(WebBackendBaseComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-badge");
        return true;
    }
    ...
    @Override
    public WebBackendBadge getComponent() {
        return ((WebBackendBadge) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendBadgeOptions) (other)) instanceof WebBackendBadgeOptions) {
            WebBackendBadgeOptions otherWebBackendBadgeOptions = ((WebBackendBadgeOptions) (other));
        }
    }
}
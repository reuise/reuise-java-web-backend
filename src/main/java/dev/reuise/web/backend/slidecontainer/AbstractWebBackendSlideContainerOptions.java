...
import dev.reuise.web.core.slidecontainer.AbstractWebSlideContainerOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSlideContainerOptions<S extends AbstractWebBackendSlideContainerOptions<S>> extends AbstractWebSlideContainerOptions<S> implements WebBackendSlideContainerOptions {
    ...
    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> slideAreaBeforeCreator;

    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> slideAreaCreator;

    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> slideAreaAfterCreator;

    protected AbstractWebBackendSlideContainerOptions() {
        this(null);
    }

    protected AbstractWebBackendSlideContainerOptions(WebBackendContainerOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-slidecontainer");
        return true;
    }
    ...
    @Override
    public WebBackendSlideContainer getComponent() {
        return ((WebBackendSlideContainer) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendSlideContainerOptions) (other)) instanceof WebBackendSlideContainerOptions) {
            WebBackendSlideContainerOptions otherWebBackendSlideContainerOptions = ((WebBackendSlideContainerOptions) (other));
            CoreContainerOptions otherSlideAreaBeforeOptions = otherWebBackendSlideContainerOptions.getSlideAreaBeforeOptions();
            if (otherSlideAreaBeforeOptions != null)
                setSlideAreaBeforeOptions(otherSlideAreaBeforeOptions);

            CoreContainerOptions otherSlideAreaOptions = otherWebBackendSlideContainerOptions.getSlideAreaOptions();
            if (otherSlideAreaOptions != null)
                setSlideAreaOptions(otherSlideAreaOptions);

            CoreContainerOptions otherSlideAreaAfterOptions = otherWebBackendSlideContainerOptions.getSlideAreaAfterOptions();
            if (otherSlideAreaAfterOptions != null)
                setSlideAreaAfterOptions(otherSlideAreaAfterOptions);

        }
    }

    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getSlideAreaBeforeCreator() {
        return slideAreaBeforeCreator;
    }

    public S setSlideAreaBeforeCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> slideAreaBeforeCreator) {
        this.slideAreaBeforeCreator = slideAreaBeforeCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultSlideAreaBeforeOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultSlideAreaBeforeOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getSlideAreaCreator() {
        return slideAreaCreator;
    }

    public S setSlideAreaCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> slideAreaCreator) {
        this.slideAreaCreator = slideAreaCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultSlideAreaOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultSlideAreaOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getSlideAreaAfterCreator() {
        return slideAreaAfterCreator;
    }

    public S setSlideAreaAfterCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> slideAreaAfterCreator) {
        this.slideAreaAfterCreator = slideAreaAfterCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultSlideAreaAfterOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultSlideAreaAfterOptions()));
        return options;
    }
}
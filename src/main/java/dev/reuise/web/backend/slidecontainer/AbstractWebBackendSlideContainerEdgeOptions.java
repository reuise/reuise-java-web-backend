...
import dev.reuise.web.core.slidecontainer.AbstractWebSlideContainerEdgeOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSlideContainerEdgeOptions<S extends AbstractWebBackendSlideContainerEdgeOptions<S>> extends AbstractWebSlideContainerEdgeOptions<S> implements WebBackendSlideContainerEdgeOptions {
    ...
    protected AbstractWebBackendSlideContainerEdgeOptions() {
        this(null);
    }

    protected AbstractWebBackendSlideContainerEdgeOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-slidecontainer_edge");
        return true;
    }
    ...
    @Override
    public WebBackendSlideContainerEdge getComponent() {
        return ((WebBackendSlideContainerEdge) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendSlideContainerEdgeOptions) (other)) instanceof WebBackendSlideContainerEdgeOptions) {
            WebBackendSlideContainerEdgeOptions otherWebBackendSlideContainerEdgeOptions = ((WebBackendSlideContainerEdgeOptions) (other));
        }
    }
}
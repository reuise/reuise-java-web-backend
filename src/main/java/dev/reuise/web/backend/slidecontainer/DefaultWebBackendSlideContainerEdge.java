...
import dev.reuise.web.core.slidecontainer.DefaultWebSlideContainerEdgePart;
...
public abstract class DefaultWebBackendSlideContainerEdge<S extends DefaultWebBackendSlideContainerEdge<S, O>, O extends WebBackendSlideContainerEdgeOptions> extends DefaultWebSlideContainerEdgePart<S, O> implements WebBackendSlideContainerEdge , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendSlideContainerEdge(O options) {
        super(options);

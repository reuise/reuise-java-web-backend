...
import dev.reuise.web.core.slidecontainer.DefaultWebSlideContainerPart;
...
public abstract class DefaultWebBackendSlideContainer<S extends DefaultWebBackendSlideContainer<S, O>, O extends WebBackendSlideContainerOptions> extends DefaultWebSlideContainerPart<S, O> implements WebBackendSlideContainer , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendSlideContainer(O options) {
        super(options);
    ...
    @Override
    public WebBackendContainer getSlideAreaBefore() {
        return ((WebBackendContainer) (super.getSlideAreaBefore()));
    }

    @Override
    public WebBackendContainer getSlideArea() {
        return ((WebBackendContainer) (super.getSlideArea()));
    }

    @Override
    public WebBackendContainer getSlideAreaAfter() {
        return ((WebBackendContainer) (super.getSlideAreaAfter()));
    }

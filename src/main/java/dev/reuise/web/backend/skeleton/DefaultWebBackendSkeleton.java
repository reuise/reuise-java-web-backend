...
import dev.reuise.web.core.skeleton.DefaultWebSkeletonPart;
...
public abstract class DefaultWebBackendSkeleton<S extends DefaultWebBackendSkeleton<S, O>, O extends WebBackendSkeletonOptions> extends DefaultWebSkeletonPart<S, O> implements WebBackendComponentType<S, O> , WebBackendSkeleton {
    protected final WebBackendBaseComponentPart baseComponentPart;

    protected DefaultWebBackendSkeleton(O options) {
        super(options);

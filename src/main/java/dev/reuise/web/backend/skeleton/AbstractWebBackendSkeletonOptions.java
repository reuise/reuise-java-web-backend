...
import dev.reuise.web.core.skeleton.AbstractWebSkeletonOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSkeletonOptions<S extends AbstractWebBackendSkeletonOptions<S>> extends AbstractWebSkeletonOptions<S> implements WebBackendSkeletonOptions {
    protected final WebBackendBaseComponentPartOptions baseComponentPart;

    protected AbstractWebBackendSkeletonOptions() {
        this(null);
    }

    protected AbstractWebBackendSkeletonOptions(WebBackendBaseComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-skeleton");
        return true;
    }
    ...
    @Override
    public WebBackendSkeleton getComponent() {
        return ((WebBackendSkeleton) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendSkeletonOptions) (other)) instanceof WebBackendSkeletonOptions) {
            WebBackendSkeletonOptions otherWebBackendSkeletonOptions = ((WebBackendSkeletonOptions) (other));
        }
    }
}
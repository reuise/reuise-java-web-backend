...
import dev.reuise.web.core.parentcomponent.AbstractWebParentComponentOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendParentComponentOptions<S extends AbstractWebBackendParentComponentOptions<S>> extends AbstractWebParentComponentOptions<S> implements WebBackendParentComponentOptions {
    protected final WebBackendBaseComponentPartOptions baseComponentPart;

    protected AbstractWebBackendParentComponentOptions() {
        this(null);
    }

    protected AbstractWebBackendParentComponentOptions(WebBackendBaseComponentOptions baseOptions) {
    ...
    @Override
    public WebBackendParentComponent getComponent() {
        return ((WebBackendParentComponent) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendParentComponentOptions) (other)) instanceof WebBackendParentComponentOptions) {
            WebBackendParentComponentOptions otherWebBackendParentComponentOptions = ((WebBackendParentComponentOptions) (other));
        }
    }
}
...
import dev.reuise.web.core.chip.AbstractWebChipOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendChipOptions<S extends AbstractWebBackendChipOptions<S>> extends AbstractWebChipOptions<S> implements WebBackendChipOptions {
    ...
    protected AbstractWebBackendChipOptions() {
        this(null);
    }

    protected AbstractWebBackendChipOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("span");
        setBaseStyleClass("reuise-chip");
        setStoreInElementOptions(new ArrayList(Arrays.asList("value")));
        return true;
    }
    ...
    @Override
    public WebBackendChip getComponent() {
        return ((WebBackendChip) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendChipOptions) (other)) instanceof WebBackendChipOptions) {
            WebBackendChipOptions otherWebBackendChipOptions = ((WebBackendChipOptions) (other));
            CoreIconOptions otherStartIconOptions = otherWebBackendChipOptions.getStartIconOptions();
            if (otherStartIconOptions != null)
                setStartIconOptions(otherStartIconOptions);

            CoreLabelOptions otherLabelContainerOptions = otherWebBackendChipOptions.getLabelContainerOptions();
            if (otherLabelContainerOptions != null)
                setLabelContainerOptions(otherLabelContainerOptions);

            CoreIconOptions otherEndIconOptions = otherWebBackendChipOptions.getEndIconOptions();

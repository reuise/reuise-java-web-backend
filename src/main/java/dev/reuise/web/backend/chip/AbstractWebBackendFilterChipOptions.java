...
import dev.reuise.web.core.chip.AbstractWebFilterChipOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendFilterChipOptions<S extends AbstractWebBackendFilterChipOptions<S>> extends AbstractWebFilterChipOptions<S> implements WebBackendFilterChipOptions {
    protected final WebBackendChipPartOptions chipPart;
    ...
    protected AbstractWebBackendFilterChipOptions() {
        this(null);
    }

    protected AbstractWebBackendFilterChipOptions(WebBackendChipOptions baseOptions) {
        chipPart = (baseOptions != null) ? baseOptions : getComponentFactory().createChipOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setStyleClass("reuise-filterchip");
        return true;
    }
    ...
    public ComponentOption<String> getLabelOption() {
        return chipPart.getLabelOption();
    }
    ...
    public ComponentOption<String> getValueOption() {
        return chipPart.getValueOption();
    }
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendFilterChipOptions) (other)) instanceof WebBackendFilterChipOptions) {
            WebBackendFilterChipOptions otherWebBackendFilterChipOptions = ((WebBackendFilterChipOptions) (other));
        }
    }
}
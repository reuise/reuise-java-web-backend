...
import dev.reuise.web.core.chip.DefaultWebChipPart;
...
public abstract class DefaultWebBackendChip<S extends DefaultWebBackendChip<S, O>, O extends WebBackendChipOptions> extends DefaultWebChipPart<S, O> implements WebBackendComponentType<S, O> , WebBackendChip {
    ...
    protected DefaultWebBackendChip(O options) {
        super(options);

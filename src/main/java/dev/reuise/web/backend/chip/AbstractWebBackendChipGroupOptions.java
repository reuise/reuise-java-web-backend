...
import dev.reuise.web.core.chip.AbstractWebChipGroupOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendChipGroupOptions<S extends AbstractWebBackendChipGroupOptions<S>> extends AbstractWebChipGroupOptions<S> implements WebBackendChipGroupOptions {
    protected final WebBackendFieldSetPartOptions fieldSetPart;
    ...
    protected ComponentCreator<? extends CoreChip, ? extends CoreChipOptions> addButtonCreator;

    protected AbstractWebBackendChipGroupOptions() {
        this(null);
    }

    protected AbstractWebBackendChipGroupOptions(WebBackendFieldSetOptions baseOptions) {
        fieldSetPart = (baseOptions != null) ? baseOptions : getComponentFactory().createFieldSetOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-chipgroup");
        return true;
    }
    ...
    public ComponentOption<String> getLabelOption() {
        return fieldSetPart.getLabelOption();
    }
    ...
    public WebBackendFieldSetPartOptions getFieldSetPart() {
        return fieldSetPart;
    }
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendChipGroupOptions) (other)) instanceof WebBackendChipGroupOptions) {
            WebBackendChipGroupOptions otherWebBackendChipGroupOptions = ((WebBackendChipGroupOptions) (other));
            CoreChipOptions otherAddButtonOptions = otherWebBackendChipGroupOptions.getAddButtonOptions();
            if (otherAddButtonOptions != null)
                setAddButtonOptions(otherAddButtonOptions);

        }
    }

    public ComponentCreator<? extends CoreChip, ? extends CoreChipOptions> getAddButtonCreator() {
        return addButtonCreator;
    }

    public S setAddButtonCreator(ComponentCreator<? extends WebBackendChip, ? extends WebBackendChipOptions> addButtonCreator) {
        this.addButtonCreator = addButtonCreator;
        return self();
    }

    protected WebBackendChipOptions createDefaultAddButtonOptions() {
        WebBackendChipOptions options = ((WebBackendChipOptions) (super.createDefaultAddButtonOptions()));
        return options;
    }
}
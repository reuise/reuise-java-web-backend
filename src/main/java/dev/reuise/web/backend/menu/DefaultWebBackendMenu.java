...
import dev.reuise.web.core.menu.DefaultWebMenuPart;
...
public abstract class DefaultWebBackendMenu<S extends DefaultWebBackendMenu<S, O>, O extends WebBackendMenuOptions> extends DefaultWebMenuPart<S, O> implements WebBackendComponentType<S, O> , WebBackendMenu {
    ...
    protected DefaultWebBackendMenu(O options) {
        super(options);
    ...
    @Override
    public WebBackendListView getList() {
        return ((WebBackendListView) (super.getList()));
    }

...
import dev.reuise.web.core.menu.AbstractWebMenuDividerOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendMenuDividerOptions<S extends AbstractWebBackendMenuDividerOptions<S>> extends AbstractWebMenuDividerOptions<S> implements WebBackendMenuDividerOptions {
    protected final WebBackendMenuItemPartOptions menuItemPart;

    protected final WebBackendListItemPartOptions listItemPart;
    ...
    protected AbstractWebBackendMenuDividerOptions() {
        this(null);
    }

    protected AbstractWebBackendMenuDividerOptions(WebBackendMenuItemOptions baseOptions) {
        menuItemPart = (baseOptions != null) ? baseOptions : getComponentFactory().createMenuItemOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-menudivider");
        return true;
    }
    ...
    public WebBackendMenuItemPartOptions getMenuItemPart() {
        return menuItemPart;
    }

    @Override
    public String getLabel() {
        return listItemPart.getLabel();
    }

    @Override
    public ComponentOption<String> getLabelOption() {
        return listItemPart.getLabelOption();
    }

    @Override
    public S setLabel(String label) {
        this.listItemPart.setLabel(label);
        return self();
    }

    @Override
    public String getSecondaryLabel() {
        return listItemPart.getSecondaryLabel();
    }

    @Override
    public ComponentOption<String> getSecondaryLabelOption() {
        return listItemPart.getSecondaryLabelOption();
    }

    @Override
    public S setSecondaryLabel(String secondaryLabel) {
        this.listItemPart.setSecondaryLabel(secondaryLabel);
        return self();
    }

    @Override
    public boolean isHasCheckbox() {
        return listItemPart.isHasCheckbox();
    }

    @Override
    public ComponentOption<Boolean> getHasCheckboxOption() {
        return listItemPart.getHasCheckboxOption();
    }

    @Override
    public S setHasCheckbox(Boolean hasCheckbox) {
        this.listItemPart.setHasCheckbox(hasCheckbox);
        return self();
    }

    @Override
    public boolean isToggleCheckboxOnClick() {
        return listItemPart.isToggleCheckboxOnClick();
    }

    @Override
    public ComponentOption<Boolean> getToggleCheckboxOnClickOption() {
        return listItemPart.getToggleCheckboxOnClickOption();
    }

    @Override
    public S setToggleCheckboxOnClick(Boolean toggleCheckboxOnClick) {
        this.listItemPart.setToggleCheckboxOnClick(toggleCheckboxOnClick);
        return self();
    }

    @Override
    public CoreCheckboxOptions getCheckboxOptions() {
        return listItemPart.getCheckboxOptions();
    }

    @Override
    public S setCheckboxOptions(CoreCheckboxOptions checkboxOptions) {
        this.listItemPart.setCheckboxOptions(checkboxOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreCheckbox, ? extends CoreCheckboxOptions> getCheckboxCreator() {
        return listItemPart.getCheckboxCreator();
    }
    ...
    public S setCheckboxCreator(ComponentCreator<? extends WebBackendCheckbox, ? extends WebBackendCheckboxOptions> checkboxCreator) {
        this.listItemPart.setCheckboxCreator(checkboxCreator);
        return self();
    }

    @Override
    public boolean hasCheckboxOptions() {
        return listItemPart.hasCheckboxOptions();
    }

    @Override
    public CoreIconOptions getStartIconOptions() {
        return listItemPart.getStartIconOptions();
    }

    @Override
    public S setStartIconOptions(CoreIconOptions startIconOptions) {
        this.listItemPart.setStartIconOptions(startIconOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreIcon, ? extends CoreIconOptions> getStartIconCreator() {
        return listItemPart.getStartIconCreator();
    }

    @Override
    public S setStartIconCreator(ComponentCreator<? extends WebBackendIcon, ? extends WebBackendIconOptions> startIconCreator) {
        this.listItemPart.setStartIconCreator(startIconCreator);
        return self();
    }

    @Override
    public boolean hasStartIconOptions() {
        return listItemPart.hasStartIconOptions();
    }

    @Override
    public CoreContainerOptions getTextContainerOptions() {
        return listItemPart.getTextContainerOptions();
    }

    @Override
    public S setTextContainerOptions(CoreContainerOptions textContainerOptions) {
        this.listItemPart.setTextContainerOptions(textContainerOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getTextContainerCreator() {
        return listItemPart.getTextContainerCreator();
    }
    ...
    public S setTextContainerCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> textContainerCreator) {
        this.listItemPart.setTextContainerCreator(textContainerCreator);
        return self();
    }

    @Override
    public boolean hasTextContainerOptions() {
        return listItemPart.hasTextContainerOptions();
    }

    @Override
    public CoreInlineTextOptions getLabelContainerOptions() {
        return listItemPart.getLabelContainerOptions();
    }

    @Override
    public S setLabelContainerOptions(CoreInlineTextOptions labelContainerOptions) {
        this.listItemPart.setLabelContainerOptions(labelContainerOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreInlineText, ? extends CoreInlineTextOptions> getLabelContainerCreator() {
        return listItemPart.getLabelContainerCreator();
    }
    ...
    public S setLabelContainerCreator(ComponentCreator<? extends WebBackendInlineText, ? extends WebBackendInlineTextOptions> labelContainerCreator) {
        this.listItemPart.setLabelContainerCreator(labelContainerCreator);
        return self();
    }

    @Override
    public boolean hasLabelContainerOptions() {
        return listItemPart.hasLabelContainerOptions();
    }

    @Override
    public CoreInlineTextOptions getSecondaryLabelContainerOptions() {
        return listItemPart.getSecondaryLabelContainerOptions();
    }

    @Override
    public S setSecondaryLabelContainerOptions(CoreInlineTextOptions secondaryLabelContainerOptions) {
        this.listItemPart.setSecondaryLabelContainerOptions(secondaryLabelContainerOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreInlineText, ? extends CoreInlineTextOptions> getSecondaryLabelContainerCreator() {
        return listItemPart.getSecondaryLabelContainerCreator();
    }
    ...
    public S setSecondaryLabelContainerCreator(ComponentCreator<? extends WebBackendInlineText, ? extends WebBackendInlineTextOptions> secondaryLabelContainerCreator) {
        this.listItemPart.setSecondaryLabelContainerCreator(secondaryLabelContainerCreator);
        return self();
    }

    @Override
    public boolean hasSecondaryLabelContainerOptions() {
        return listItemPart.hasSecondaryLabelContainerOptions();
    }

    @Override
    public CoreIconOptions getEndIconOptions() {
        return listItemPart.getEndIconOptions();
    }

    @Override
    public S setEndIconOptions(CoreIconOptions endIconOptions) {
        this.listItemPart.setEndIconOptions(endIconOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreIcon, ? extends CoreIconOptions> getEndIconCreator() {
        return listItemPart.getEndIconCreator();
    }

    @Override
    public S setEndIconCreator(ComponentCreator<? extends WebBackendIcon, ? extends WebBackendIconOptions> endIconCreator) {
        this.listItemPart.setEndIconCreator(endIconCreator);
        return self();
    }

    @Override
    public boolean hasEndIconOptions() {
        return listItemPart.hasEndIconOptions();
    }

    public WebBackendListItemPartOptions getListItemPart() {
        return listItemPart;
    }
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendMenuDividerOptions) (other)) instanceof WebBackendMenuDividerOptions) {
            WebBackendMenuDividerOptions otherWebBackendMenuDividerOptions = ((WebBackendMenuDividerOptions) (other));
        }
    }
}
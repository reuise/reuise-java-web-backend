...
import dev.reuise.web.core.menu.AbstractWebMenuItemOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendMenuItemOptions<S extends AbstractWebBackendMenuItemOptions<S>> extends AbstractWebMenuItemOptions<S> implements WebBackendMenuItemOptions {
    ...
    protected AbstractWebBackendMenuItemOptions() {
        this(null);
    }

    protected AbstractWebBackendMenuItemOptions(WebBackendListItemOptions baseOptions) {
        listItemPart = (baseOptions != null) ? baseOptions : getComponentFactory().createListItemOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("li");
        setBaseStyleClass("reuise-menuitem");
        return true;
    }
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendMenuItemOptions) (other)) instanceof WebBackendMenuItemOptions) {
            WebBackendMenuItemOptions otherWebBackendMenuItemOptions = ((WebBackendMenuItemOptions) (other));
        }
    }
}
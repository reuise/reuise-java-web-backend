...
import dev.reuise.web.core.avatar.DefaultWebAvatarPart;
...
public abstract class DefaultWebBackendAvatar<S extends DefaultWebBackendAvatar<S, O>, O extends WebBackendAvatarOptions> extends DefaultWebAvatarPart<S, O> implements WebBackendComponentType<S, O> , WebBackendAvatar {
    ...
    protected DefaultWebBackendAvatar(O options) {
        super(options);

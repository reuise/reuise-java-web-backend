...
import dev.reuise.web.core.avatar.AbstractWebAvatarOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendAvatarOptions<S extends AbstractWebBackendAvatarOptions<S>> extends AbstractWebAvatarOptions<S> implements WebBackendAvatarOptions {
    ...
    protected AbstractWebBackendAvatarOptions() {
        this(null);
    }

    protected AbstractWebBackendAvatarOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-avatar");
        return true;
    }
    ...
    @Override
    public WebBackendAvatar getComponent() {
        return ((WebBackendAvatar) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendAvatarOptions) (other)) instanceof WebBackendAvatarOptions) {
            WebBackendAvatarOptions otherWebBackendAvatarOptions = ((WebBackendAvatarOptions) (other));
            CoreImageOptions otherImageOptions = otherWebBackendAvatarOptions.getImageOptions();
            if (otherImageOptions != null)
                setImageOptions(otherImageOptions);

            CoreBadgeOptions otherBadgeOptions = otherWebBackendAvatarOptions.getBadgeOptions();

...
import dev.reuise.web.core.dropzone.AbstractWebDropZoneOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendDropZoneOptions<S extends AbstractWebBackendDropZoneOptions<S>> extends AbstractWebDropZoneOptions<S> implements WebBackendDropZoneOptions {
    ...
    protected AbstractWebBackendDropZoneOptions() {
        this(null);
    }

    protected AbstractWebBackendDropZoneOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-dropzone");
        return true;
    }
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendDropZoneOptions) (other)) instanceof WebBackendDropZoneOptions) {
            WebBackendDropZoneOptions otherWebBackendDropZoneOptions = ((WebBackendDropZoneOptions) (other));
        }
    }
}
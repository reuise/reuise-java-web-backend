...
import dev.reuise.web.core.drawer.AbstractWebDrawerOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendDrawerOptions<S extends AbstractWebBackendDrawerOptions<S>> extends AbstractWebDrawerOptions<S> implements WebBackendDrawerOptions {
    ...
    protected AbstractWebBackendDrawerOptions() {
        this(null);
    }

    protected AbstractWebBackendDrawerOptions(WebBackendContainerOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-drawer");
        setStoreInElementOptions(new ArrayList(Arrays.asList("resizable", "minSize", "maxSize", "transitionDuration")));
        return true;
    }
    ...
    @Override
    public WebBackendDrawer getComponent() {
        return ((WebBackendDrawer) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendDrawerOptions) (other)) instanceof WebBackendDrawerOptions) {
            WebBackendDrawerOptions otherWebBackendDrawerOptions = ((WebBackendDrawerOptions) (other));
        }
    }
}
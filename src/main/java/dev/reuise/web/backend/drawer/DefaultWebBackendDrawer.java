...
import dev.reuise.web.core.drawer.DefaultWebDrawerPart;
...
public abstract class DefaultWebBackendDrawer<S extends DefaultWebBackendDrawer<S, O>, O extends WebBackendDrawerOptions> extends DefaultWebDrawerPart<S, O> implements WebBackendComponentType<S, O> , WebBackendDrawer {
    ...
    protected DefaultWebBackendDrawer(O options) {
        super(options);

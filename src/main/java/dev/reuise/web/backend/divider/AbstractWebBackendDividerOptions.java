...
import dev.reuise.web.core.divider.AbstractWebDividerOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendDividerOptions<S extends AbstractWebBackendDividerOptions<S>> extends AbstractWebDividerOptions<S> implements WebBackendDividerOptions {
    ...
    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> startLineCreator;

    protected ComponentCreator<? extends CoreInlineText, ? extends CoreInlineTextOptions> labelContainerCreator;

    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> endLineCreator;

    protected AbstractWebBackendDividerOptions() {
        this(null);
    }

    protected AbstractWebBackendDividerOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-divider");
        return true;
    }
    ...
    @Override
    public WebBackendDivider getComponent() {
        return ((WebBackendDivider) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendDividerOptions) (other)) instanceof WebBackendDividerOptions) {
            WebBackendDividerOptions otherWebBackendDividerOptions = ((WebBackendDividerOptions) (other));
            CoreContainerOptions otherStartLineOptions = otherWebBackendDividerOptions.getStartLineOptions();
            if (otherStartLineOptions != null)
                setStartLineOptions(otherStartLineOptions);

            CoreInlineTextOptions otherLabelContainerOptions = otherWebBackendDividerOptions.getLabelContainerOptions();
            if (otherLabelContainerOptions != null)
                setLabelContainerOptions(otherLabelContainerOptions);

            CoreContainerOptions otherEndLineOptions = otherWebBackendDividerOptions.getEndLineOptions();
            if (otherEndLineOptions != null)
                setEndLineOptions(otherEndLineOptions);

        }
    }

    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getStartLineCreator() {
        return startLineCreator;
    }

    public S setStartLineCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> startLineCreator) {
        this.startLineCreator = startLineCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultStartLineOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultStartLineOptions()));
        return options;
    }
    ...
    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getEndLineCreator() {
        return endLineCreator;
    }

    public S setEndLineCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> endLineCreator) {
        this.endLineCreator = endLineCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultEndLineOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultEndLineOptions()));
        return options;
    }
}
...
import dev.reuise.web.core.divider.DefaultWebDividerPart;
...
public abstract class DefaultWebBackendDivider<S extends DefaultWebBackendDivider<S, O>, O extends WebBackendDividerOptions> extends DefaultWebDividerPart<S, O> implements WebBackendComponentType<S, O> , WebBackendDivider {
    ...
    protected DefaultWebBackendDivider(O options) {
        super(options);
    ...
    @Override
    public WebBackendContainer getStartLine() {
        return ((WebBackendContainer) (super.getStartLine()));
    }
    ...
    @Override
    public WebBackendContainer getEndLine() {
        return ((WebBackendContainer) (super.getEndLine()));
    }

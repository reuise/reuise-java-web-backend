...
import dev.reuise.web.core.checkbox.AbstractWebCheckboxOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendCheckboxOptions<S extends AbstractWebBackendCheckboxOptions<S>> extends AbstractWebCheckboxOptions<S> implements WebBackendCheckboxOptions {
    ...
    protected ComponentCreator<? extends CoreBasicCheckbox, ? extends CoreBasicCheckboxOptions> checkboxCreator;

    protected ComponentCreator<? extends CoreLabel, ? extends CoreLabelOptions> labelContainerCreator;

    protected AbstractWebBackendCheckboxOptions() {
        this(null);
    }

    protected AbstractWebBackendCheckboxOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-checkbox");
        return true;
    }
    ...
    @Override
    public WebBackendCheckbox getComponent() {
        return ((WebBackendCheckbox) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendCheckboxOptions) (other)) instanceof WebBackendCheckboxOptions) {
            WebBackendCheckboxOptions otherWebBackendCheckboxOptions = ((WebBackendCheckboxOptions) (other));
            CoreBasicCheckboxOptions otherCheckboxOptions = otherWebBackendCheckboxOptions.getCheckboxOptions();
            if (otherCheckboxOptions != null)
                setCheckboxOptions(otherCheckboxOptions);

            CoreLabelOptions otherLabelContainerOptions = otherWebBackendCheckboxOptions.getLabelContainerOptions();
    ...
    public ComponentCreator<? extends CoreBasicCheckbox, ? extends CoreBasicCheckboxOptions> getCheckboxCreator() {
        return checkboxCreator;
    }

    public S setCheckboxCreator(ComponentCreator<? extends WebBackendBasicCheckbox, ? extends WebBackendBasicCheckboxOptions> checkboxCreator) {
        this.checkboxCreator = checkboxCreator;
        return self();
    }

    protected WebBackendBasicCheckboxOptions createDefaultCheckboxOptions() {
        WebBackendBasicCheckboxOptions options = ((WebBackendBasicCheckboxOptions) (super.createDefaultCheckboxOptions()));
        return options;
    }

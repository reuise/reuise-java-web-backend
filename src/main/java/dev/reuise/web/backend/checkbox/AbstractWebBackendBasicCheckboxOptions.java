...
import dev.reuise.web.core.checkbox.AbstractWebBasicCheckboxOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendBasicCheckboxOptions<S extends AbstractWebBackendBasicCheckboxOptions<S>> extends AbstractWebBasicCheckboxOptions<S> implements WebBackendBasicCheckboxOptions {
    protected final WebBackendBaseComponentPartOptions baseComponentPart;

    protected AbstractWebBackendBasicCheckboxOptions() {
        this(null);
    }

    protected AbstractWebBackendBasicCheckboxOptions(WebBackendBaseComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("input");
        setBaseStyleClass("reuise-basiccheckbox");
        return true;
    }
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendBasicCheckboxOptions) (other)) instanceof WebBackendBasicCheckboxOptions) {
            WebBackendBasicCheckboxOptions otherWebBackendBasicCheckboxOptions = ((WebBackendBasicCheckboxOptions) (other));
        }
    }
}
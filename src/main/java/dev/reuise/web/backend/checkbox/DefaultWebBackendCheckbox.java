...
import dev.reuise.web.core.checkbox.DefaultWebCheckboxPart;
...
public abstract class DefaultWebBackendCheckbox<S extends DefaultWebBackendCheckbox<S, O>, O extends WebBackendCheckboxOptions> extends DefaultWebCheckboxPart<S, O> implements WebBackendComponentType<S, O> , WebBackendCheckbox {
    ...
    protected DefaultWebBackendCheckbox(O options) {
        super(options);
    ...
    @Override
    public WebBackendBasicCheckbox getCheckbox() {
        return ((WebBackendBasicCheckbox) (super.getCheckbox()));
    }

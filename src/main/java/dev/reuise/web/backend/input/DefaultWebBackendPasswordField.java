...
import dev.reuise.web.core.input.DefaultWebPasswordFieldPart;
...
public abstract class DefaultWebBackendPasswordField<S extends DefaultWebBackendPasswordField<S, O>, O extends WebBackendPasswordFieldOptions> extends DefaultWebPasswordFieldPart<S, O> implements WebBackendPasswordField , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendPasswordField(O options) {
        super(options);

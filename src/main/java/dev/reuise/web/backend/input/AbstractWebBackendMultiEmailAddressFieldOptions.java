...
import dev.reuise.core.input.EmailInputValidator;
import dev.reuise.core.input.TextFieldLabelPlacement;
...
import dev.reuise.web.core.input.AbstractWebMultiEmailAddressFieldOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendMultiEmailAddressFieldOptions<S extends AbstractWebBackendMultiEmailAddressFieldOptions<S>> extends AbstractWebMultiEmailAddressFieldOptions<S> implements WebBackendMultiEmailAddressFieldOptions {
    protected final WebBackendChipFieldPartOptions chipFieldPart;

    protected final WebBackendTextFieldPartOptions textFieldPart;
    ...
    protected AbstractWebBackendMultiEmailAddressFieldOptions() {
        this(null);
    }

    protected AbstractWebBackendMultiEmailAddressFieldOptions(WebBackendChipFieldOptions baseOptions) {
        chipFieldPart = (baseOptions != null) ? baseOptions : getComponentFactory().createChipFieldOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setValidators(new ArrayList(Arrays.asList(new EmailInputValidator())));
        setLabel("Emails");
        setPlaceholder("Email addresses...");
        setDelimiters(new ArrayList(Arrays.asList(" ", ";", ",")));
        return true;
    }
    ...
    public ComponentOption<Boolean> getMultipleOption() {
        return chipFieldPart.getMultipleOption();
    }
    ...
    public ComponentOption<List<String>> getValuesOption() {
        return chipFieldPart.getValuesOption();
    }
    ...
    public ComponentOption<List<String>> getDelimitersOption() {
        return chipFieldPart.getDelimitersOption();
    }
    ...
    public ComponentOption<Boolean> getAllowDuplicatesOption() {
        return chipFieldPart.getAllowDuplicatesOption();
    }
    ...
    @Override
    public CoreChipGroupOptions getChipGroupOptions() {
        return chipFieldPart.getChipGroupOptions();
    }

    @Override
    public S setChipGroupOptions(CoreChipGroupOptions chipGroupOptions) {
        this.chipFieldPart.setChipGroupOptions(chipGroupOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreChipGroup, ? extends CoreChipGroupOptions> getChipGroupCreator() {
        return chipFieldPart.getChipGroupCreator();
    }

    @Override
    public S setChipGroupCreator(ComponentCreator<? extends WebBackendChipGroup, ? extends WebBackendChipGroupOptions> chipGroupCreator) {
        this.chipFieldPart.setChipGroupCreator(chipGroupCreator);
        return self();
    }

    @Override
    public boolean hasChipGroupOptions() {
        return chipFieldPart.hasChipGroupOptions();
    }

    public WebBackendChipFieldPartOptions getChipFieldPart() {
    ...
    public ComponentOption<TextFieldSize> getSizeOption() {
        return textFieldPart.getSizeOption();
    }
    ...
    public boolean isError() {
        return textFieldPart.isError();
    }

    @Override
    public ComponentOption<Boolean> getErrorOption() {
        return textFieldPart.getErrorOption();
    }

    @Override
    public S setError(Boolean error) {
        this.textFieldPart.setError(error);
        return self();
    }
    ...
    public ComponentOption<String> getSupportingTextOption() {
        return textFieldPart.getSupportingTextOption();
    }
    ...
    public ComponentOption<String> getLabelOption() {
        return textFieldPart.getLabelOption();
    }
    ...
    public ComponentOption<TextFieldLabelPlacement> getLabelPlacementOption() {
        return textFieldPart.getLabelPlacementOption();
    }
    ...
    @Override
    public CoreLabelOptions getLabelContainerOptions() {
        return textFieldPart.getLabelContainerOptions();
    }

    @Override
    public S setLabelContainerOptions(CoreLabelOptions labelContainerOptions) {
        this.textFieldPart.setLabelContainerOptions(labelContainerOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreLabel, ? extends CoreLabelOptions> getLabelContainerCreator() {
        return textFieldPart.getLabelContainerCreator();
    }

    @Override
    public S setLabelContainerCreator(ComponentCreator<? extends WebBackendLabel, ? extends WebBackendLabelOptions> labelContainerCreator) {
        this.textFieldPart.setLabelContainerCreator(labelContainerCreator);
        return self();
    }

    @Override
    public boolean hasLabelContainerOptions() {
        return textFieldPart.hasLabelContainerOptions();
    }

    @Override
    public CoreContainerOptions getInputContainerOptions() {
        return textFieldPart.getInputContainerOptions();
    }

    @Override
    public S setInputContainerOptions(CoreContainerOptions inputContainerOptions) {
        this.textFieldPart.setInputContainerOptions(inputContainerOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getInputContainerCreator() {
        return textFieldPart.getInputContainerCreator();
    }

    @Override
    public S setInputContainerCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> inputContainerCreator) {
        this.textFieldPart.setInputContainerCreator(inputContainerCreator);
        return self();
    }

    @Override
    public boolean hasInputContainerOptions() {
        return textFieldPart.hasInputContainerOptions();
    }

    @Override
    public CoreIconOptions getStartIconOptions() {
        return textFieldPart.getStartIconOptions();
    }

    @Override
    public S setStartIconOptions(CoreIconOptions startIconOptions) {
        this.textFieldPart.setStartIconOptions(startIconOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreIcon, ? extends CoreIconOptions> getStartIconCreator() {
        return textFieldPart.getStartIconCreator();
    }

    @Override
    public S setStartIconCreator(ComponentCreator<? extends WebBackendIcon, ? extends WebBackendIconOptions> startIconCreator) {
        this.textFieldPart.setStartIconCreator(startIconCreator);
        return self();
    }

    @Override
    public boolean hasStartIconOptions() {
        return textFieldPart.hasStartIconOptions();
    }

    @Override
    public CoreBasicInputFieldOptions getInputOptions() {
        return textFieldPart.getInputOptions();
    }

    @Override
    public S setInputOptions(CoreBasicInputFieldOptions inputOptions) {
        this.textFieldPart.setInputOptions(inputOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreBasicInputField, ? extends CoreBasicInputFieldOptions> getInputCreator() {
        return textFieldPart.getInputCreator();
    }

    @Override
    public S setInputCreator(ComponentCreator<? extends WebBackendBasicInputField, ? extends WebBackendBasicInputFieldOptions> inputCreator) {
        this.textFieldPart.setInputCreator(inputCreator);
        return self();
    }

    @Override
    public boolean hasInputOptions() {
        return textFieldPart.hasInputOptions();
    }

    @Override
    public CoreIconOptions getEndIconOptions() {
        return textFieldPart.getEndIconOptions();
    }

    @Override
    public S setEndIconOptions(CoreIconOptions endIconOptions) {
        this.textFieldPart.setEndIconOptions(endIconOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreIcon, ? extends CoreIconOptions> getEndIconCreator() {
        return textFieldPart.getEndIconCreator();
    }

    @Override
    public S setEndIconCreator(ComponentCreator<? extends WebBackendIcon, ? extends WebBackendIconOptions> endIconCreator) {
        this.textFieldPart.setEndIconCreator(endIconCreator);
        return self();
    }

    @Override
    public boolean hasEndIconOptions() {
        return textFieldPart.hasEndIconOptions();
    }

    @Override
    public CoreInlineTextOptions getSupportingTextContainerOptions() {
        return textFieldPart.getSupportingTextContainerOptions();
    }

    @Override
    public S setSupportingTextContainerOptions(CoreInlineTextOptions supportingTextContainerOptions) {
        this.textFieldPart.setSupportingTextContainerOptions(supportingTextContainerOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreInlineText, ? extends CoreInlineTextOptions> getSupportingTextContainerCreator() {
        return textFieldPart.getSupportingTextContainerCreator();
    }

    @Override
    public S setSupportingTextContainerCreator(ComponentCreator<? extends WebBackendInlineText, ? extends WebBackendInlineTextOptions> supportingTextContainerCreator) {
        this.textFieldPart.setSupportingTextContainerCreator(supportingTextContainerCreator);
        return self();
    }

    @Override
    public boolean hasSupportingTextContainerOptions() {
        return textFieldPart.hasSupportingTextContainerOptions();
    }

    public WebBackendTextFieldPartOptions getTextFieldPart() {
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendMultiEmailAddressFieldOptions) (other)) instanceof WebBackendMultiEmailAddressFieldOptions) {
            WebBackendMultiEmailAddressFieldOptions otherWebBackendMultiEmailAddressFieldOptions = ((WebBackendMultiEmailAddressFieldOptions) (other));
        }
    }
}
...
import dev.reuise.web.core.input.AbstractWebSearchFieldOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSearchFieldOptions<S extends AbstractWebBackendSearchFieldOptions<S>> extends AbstractWebSearchFieldOptions<S> implements WebBackendSearchFieldOptions {
    ...
    protected AbstractWebBackendSearchFieldOptions() {
        this(null);
    }

    protected AbstractWebBackendSearchFieldOptions(WebBackendTextFieldOptions baseOptions) {
    ...
    @Override
    public WebBackendSearchField getComponent() {
        return ((WebBackendSearchField) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendSearchFieldOptions) (other)) instanceof WebBackendSearchFieldOptions) {
            WebBackendSearchFieldOptions otherWebBackendSearchFieldOptions = ((WebBackendSearchFieldOptions) (other));
        }
    }
}
...
import dev.reuise.web.core.input.AbstractWebPasswordFieldOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendPasswordFieldOptions<S extends AbstractWebBackendPasswordFieldOptions<S>> extends AbstractWebPasswordFieldOptions<S> implements WebBackendPasswordFieldOptions {
    ...
    protected AbstractWebBackendPasswordFieldOptions() {
        this(null);
    }

    protected AbstractWebBackendPasswordFieldOptions(WebBackendTextFieldOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setValidator(new PasswordInputValidator());
        return true;
    }
    ...
    @Override
    public WebBackendPasswordField getComponent() {
        return ((WebBackendPasswordField) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendPasswordFieldOptions) (other)) instanceof WebBackendPasswordFieldOptions) {
            WebBackendPasswordFieldOptions otherWebBackendPasswordFieldOptions = ((WebBackendPasswordFieldOptions) (other));
        }
    }
}
...
import dev.reuise.web.core.input.AbstractWebChipFieldOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendChipFieldOptions<S extends AbstractWebBackendChipFieldOptions<S>> extends AbstractWebChipFieldOptions<S> implements WebBackendChipFieldOptions {
    ...
    protected ComponentCreator<? extends CoreChipGroup, ? extends CoreChipGroupOptions> chipGroupCreator;

    protected AbstractWebBackendChipFieldOptions() {
        this(null);
    }

    protected AbstractWebBackendChipFieldOptions(WebBackendTextFieldOptions baseOptions) {
        textFieldPart = (baseOptions != null) ? baseOptions : getComponentFactory().createTextFieldOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setStyleClass("reuise-chipfield");
        setStoreInElementOptions(new ArrayList(Arrays.asList("multiple")));
        return true;
    }
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendChipFieldOptions) (other)) instanceof WebBackendChipFieldOptions) {
            WebBackendChipFieldOptions otherWebBackendChipFieldOptions = ((WebBackendChipFieldOptions) (other));
            CoreChipGroupOptions otherChipGroupOptions = otherWebBackendChipFieldOptions.getChipGroupOptions();
            if (otherChipGroupOptions != null)
                setChipGroupOptions(otherChipGroupOptions);

        }
    }

    public ComponentCreator<? extends CoreChipGroup, ? extends CoreChipGroupOptions> getChipGroupCreator() {
        return chipGroupCreator;
    }
    ...
    public S setChipGroupCreator(ComponentCreator<? extends WebBackendChipGroup, ? extends WebBackendChipGroupOptions> chipGroupCreator) {
        this.chipGroupCreator = chipGroupCreator;
        return self();
    }

    protected WebBackendChipGroupOptions createDefaultChipGroupOptions() {
        WebBackendChipGroupOptions options = ((WebBackendChipGroupOptions) (super.createDefaultChipGroupOptions()));
        return options;
    }
}
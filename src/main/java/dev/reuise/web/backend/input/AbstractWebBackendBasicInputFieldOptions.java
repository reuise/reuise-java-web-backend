...
import dev.reuise.web.core.input.AbstractWebBasicInputFieldOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendBasicInputFieldOptions<S extends AbstractWebBackendBasicInputFieldOptions<S>> extends AbstractWebBasicInputFieldOptions<S> implements WebBackendBasicInputFieldOptions {
    protected final WebBackendBaseComponentPartOptions baseComponentPart;

    protected AbstractWebBackendBasicInputFieldOptions() {
        this(null);
    }

    protected AbstractWebBackendBasicInputFieldOptions(WebBackendBaseComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("input");
        setBaseStyleClass("reuise-input");
        setStoreInElementOptions(new ArrayList(Arrays.asList("maxlines")));
        return true;
    }
    ...
    @Override
    public WebBackendBasicInputField getComponent() {
        return ((WebBackendBasicInputField) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendBasicInputFieldOptions) (other)) instanceof WebBackendBasicInputFieldOptions) {
            WebBackendBasicInputFieldOptions otherWebBackendBasicInputFieldOptions = ((WebBackendBasicInputFieldOptions) (other));
        }
    }
}
...
import dev.reuise.web.core.input.AbstractWebTextFieldOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendTextFieldOptions<S extends AbstractWebBackendTextFieldOptions<S>> extends AbstractWebTextFieldOptions<S> implements WebBackendTextFieldOptions {
    ...
    protected ComponentCreator<? extends CoreLabel, ? extends CoreLabelOptions> labelContainerCreator;

    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> inputContainerCreator;

    protected ComponentCreator<? extends CoreIcon, ? extends CoreIconOptions> startIconCreator;

    protected ComponentCreator<? extends CoreBasicInputField, ? extends CoreBasicInputFieldOptions> inputCreator;

    protected ComponentCreator<? extends CoreIcon, ? extends CoreIconOptions> endIconCreator;

    protected ComponentCreator<? extends CoreInlineText, ? extends CoreInlineTextOptions> supportingTextContainerCreator;

    protected AbstractWebBackendTextFieldOptions() {
        this(null);
    }

    protected AbstractWebBackendTextFieldOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-textfield");
        return true;
    }
    ...
    @Override
    public WebBackendTextField getComponent() {
        return ((WebBackendTextField) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendTextFieldOptions) (other)) instanceof WebBackendTextFieldOptions) {
            WebBackendTextFieldOptions otherWebBackendTextFieldOptions = ((WebBackendTextFieldOptions) (other));
            CoreLabelOptions otherLabelContainerOptions = otherWebBackendTextFieldOptions.getLabelContainerOptions();
            if (otherLabelContainerOptions != null)
                setLabelContainerOptions(otherLabelContainerOptions);

            CoreContainerOptions otherInputContainerOptions = otherWebBackendTextFieldOptions.getInputContainerOptions();
            if (otherInputContainerOptions != null)
                setInputContainerOptions(otherInputContainerOptions);

            CoreIconOptions otherStartIconOptions = otherWebBackendTextFieldOptions.getStartIconOptions();
            if (otherStartIconOptions != null)
                setStartIconOptions(otherStartIconOptions);

            CoreBasicInputFieldOptions otherInputOptions = otherWebBackendTextFieldOptions.getInputOptions();
            if (otherInputOptions != null)
                setInputOptions(otherInputOptions);

            CoreIconOptions otherEndIconOptions = otherWebBackendTextFieldOptions.getEndIconOptions();
            if (otherEndIconOptions != null)
                setEndIconOptions(otherEndIconOptions);

            CoreInlineTextOptions otherSupportingTextContainerOptions = otherWebBackendTextFieldOptions.getSupportingTextContainerOptions();
            if (otherSupportingTextContainerOptions != null)
                setSupportingTextContainerOptions(otherSupportingTextContainerOptions);
    ...
    protected WebBackendLabelOptions createDefaultLabelContainerOptions() {
        WebBackendLabelOptions options = ((WebBackendLabelOptions) (super.createDefaultLabelContainerOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getInputContainerCreator() {
        return inputContainerCreator;
    }
    ...
    public S setInputContainerCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> inputContainerCreator) {
        this.inputContainerCreator = inputContainerCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultInputContainerOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultInputContainerOptions()));
        return options;
    }
    ...
    protected WebBackendBasicInputFieldOptions createDefaultInputOptions() {
        WebBackendBasicInputFieldOptions options = ((WebBackendBasicInputFieldOptions) (super.createDefaultInputOptions()));
        return options;
    }
    ...
    public ComponentCreator<? extends CoreInlineText, ? extends CoreInlineTextOptions> getSupportingTextContainerCreator() {
        return supportingTextContainerCreator;
    }
    ...
    public S setSupportingTextContainerCreator(ComponentCreator<? extends WebBackendInlineText, ? extends WebBackendInlineTextOptions> supportingTextContainerCreator) {
        this.supportingTextContainerCreator = supportingTextContainerCreator;
        return self();
    }

    protected WebBackendInlineTextOptions createDefaultSupportingTextContainerOptions() {
        WebBackendInlineTextOptions options = ((WebBackendInlineTextOptions) (super.createDefaultSupportingTextContainerOptions()));
        return options;
    }
}
...
import dev.reuise.web.core.bottomappbar.AbstractWebBottomAppBarOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendBottomAppBarOptions<S extends AbstractWebBackendBottomAppBarOptions<S>> extends AbstractWebBottomAppBarOptions<S> implements WebBackendBottomAppBarOptions {
    protected final WebBackendBaseComponentPartOptions baseComponentPart;

    protected AbstractWebBackendBottomAppBarOptions() {
        this(null);
    }

    protected AbstractWebBackendBottomAppBarOptions(WebBackendBaseComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-bottom-app-bar");
        return true;
    }
    ...
    @Override
    public WebBackendBottomAppBar getComponent() {
        return ((WebBackendBottomAppBar) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendBottomAppBarOptions) (other)) instanceof WebBackendBottomAppBarOptions) {
            WebBackendBottomAppBarOptions otherWebBackendBottomAppBarOptions = ((WebBackendBottomAppBarOptions) (other));
        }
    }
}
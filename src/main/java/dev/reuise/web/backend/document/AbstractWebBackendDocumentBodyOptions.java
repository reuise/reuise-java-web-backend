...
import dev.reuise.web.core.document.AbstractWebDocumentBodyOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendDocumentBodyOptions<S extends AbstractWebBackendDocumentBodyOptions<S>> extends AbstractWebDocumentBodyOptions<S> implements WebBackendDocumentBodyOptions {
    ...
    protected AbstractWebBackendDocumentBodyOptions() {
        this(null);
    }

    protected AbstractWebBackendDocumentBodyOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    @Override
    public WebBackendDocumentBody getComponent() {
        return ((WebBackendDocumentBody) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendDocumentBodyOptions) (other)) instanceof WebBackendDocumentBodyOptions) {
            WebBackendDocumentBodyOptions otherWebBackendDocumentBodyOptions = ((WebBackendDocumentBodyOptions) (other));
        }
    }
}
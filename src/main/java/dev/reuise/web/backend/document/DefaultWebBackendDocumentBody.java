...
import dev.reuise.web.core.document.DefaultWebDocumentBodyPart;
...
public abstract class DefaultWebBackendDocumentBody<S extends DefaultWebBackendDocumentBody<S, O>, O extends WebBackendDocumentBodyOptions> extends DefaultWebDocumentBodyPart<S, O> implements WebBackendDocumentBody , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendDocumentBody(O options) {
        super(options);

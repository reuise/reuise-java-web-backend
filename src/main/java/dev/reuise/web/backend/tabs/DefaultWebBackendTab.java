...
import dev.reuise.web.core.tabs.DefaultWebTabPart;
...
public abstract class DefaultWebBackendTab<S extends DefaultWebBackendTab<S, O>, O extends WebBackendTabOptions> extends DefaultWebTabPart<S, O> implements WebBackendComponentType<S, O> , WebBackendTab {
    ...
    protected DefaultWebBackendTab(O options) {
        super(options);
    ...
    public WebBackendLink getLink() {
        return ((WebBackendLink) (super.getLink()));
    }

    @Override
    public WebBackendBadge getBadge() {
        return ((WebBackendBadge) (super.getBadge()));
    }

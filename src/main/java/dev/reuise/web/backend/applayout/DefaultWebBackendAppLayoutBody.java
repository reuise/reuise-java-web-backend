...
import dev.reuise.web.core.applayout.DefaultWebAppLayoutBodyPart;
...
public abstract class DefaultWebBackendAppLayoutBody<S extends DefaultWebBackendAppLayoutBody<S, O>, O extends WebBackendAppLayoutBodyOptions> extends DefaultWebAppLayoutBodyPart<S, O> implements WebBackendComponentType<S, O> , WebBackendAppLayoutBody {
    ...
    protected DefaultWebBackendAppLayoutBody(O options) {
        super(options);
        if (options.getComponent() == null)
            options.setComponent(self());

        flexContainerPart = options.getComponentFactory().createFlexContainer(((CoreFlexContainerOptions) (options.getFlexContainerPart())));
        ...
        addPart(ComponentPart.Type.BASE, flexContainerPart);
    }

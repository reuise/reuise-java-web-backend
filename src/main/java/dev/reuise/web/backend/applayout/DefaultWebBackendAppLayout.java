...
import dev.reuise.web.core.applayout.DefaultWebAppLayoutPart;
...
public abstract class DefaultWebBackendAppLayout<S extends DefaultWebBackendAppLayout<S, O>, O extends WebBackendAppLayoutOptions> extends DefaultWebAppLayoutPart<S, O> implements WebBackendAppLayout , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendAppLayout(O options) {
        super(options);
    ...
    @Override
    public WebBackendContainer getDrawerScrim() {
        return ((WebBackendContainer) (super.getDrawerScrim()));
    }

    @Override
    public WebBackendSplitContainer getDrawerSplit() {
        return ((WebBackendSplitContainer) (super.getDrawerSplit()));
    }

    @Override
    public WebBackendSplitContainer getTopAppBarSplit() {
        return ((WebBackendSplitContainer) (super.getTopAppBarSplit()));
    }

    @Override
    public WebBackendAppLayoutBody getBody() {
        return ((WebBackendAppLayoutBody) (super.getBody()));
    }

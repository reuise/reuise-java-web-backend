...
import dev.reuise.web.core.applayout.AbstractWebAppLayoutOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendAppLayoutOptions<S extends AbstractWebBackendAppLayoutOptions<S>> extends AbstractWebAppLayoutOptions<S> implements WebBackendAppLayoutOptions {
    ...
    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> drawerScrimCreator;

    protected ComponentCreator<? extends CoreSplitContainer, ? extends CoreSplitContainerOptions> drawerSplitCreator;

    protected ComponentCreator<? extends CoreSplitContainer, ? extends CoreSplitContainerOptions> topAppBarSplitCreator;

    protected ComponentCreator<? extends CoreAppLayoutBody, ? extends CoreAppLayoutBodyOptions> bodyCreator;

    protected AbstractWebBackendAppLayoutOptions() {
        this(null);
    }

    protected AbstractWebBackendAppLayoutOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-app-layout");
        return true;
    }
    ...
    @Override
    public WebBackendAppLayout getComponent() {
        return ((WebBackendAppLayout) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendAppLayoutOptions) (other)) instanceof WebBackendAppLayoutOptions) {
            WebBackendAppLayoutOptions otherWebBackendAppLayoutOptions = ((WebBackendAppLayoutOptions) (other));
            CoreContainerOptions otherDrawerScrimOptions = otherWebBackendAppLayoutOptions.getDrawerScrimOptions();
            if (otherDrawerScrimOptions != null)
                setDrawerScrimOptions(otherDrawerScrimOptions);

            CoreSplitContainerOptions otherDrawerSplitOptions = otherWebBackendAppLayoutOptions.getDrawerSplitOptions();
            if (otherDrawerSplitOptions != null)
                setDrawerSplitOptions(otherDrawerSplitOptions);

            CoreSplitContainerOptions otherTopAppBarSplitOptions = otherWebBackendAppLayoutOptions.getTopAppBarSplitOptions();
            if (otherTopAppBarSplitOptions != null)
                setTopAppBarSplitOptions(otherTopAppBarSplitOptions);

            CoreAppLayoutBodyOptions otherBodyOptions = otherWebBackendAppLayoutOptions.getBodyOptions();
    ...
    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getDrawerScrimCreator() {
        return drawerScrimCreator;
    }

    public S setDrawerScrimCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> drawerScrimCreator) {
        this.drawerScrimCreator = drawerScrimCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultDrawerScrimOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultDrawerScrimOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreSplitContainer, ? extends CoreSplitContainerOptions> getDrawerSplitCreator() {
        return drawerSplitCreator;
    }

    public S setDrawerSplitCreator(ComponentCreator<? extends WebBackendSplitContainer, ? extends WebBackendSplitContainerOptions> drawerSplitCreator) {
        this.drawerSplitCreator = drawerSplitCreator;
        return self();
    }

    protected WebBackendSplitContainerOptions createDefaultDrawerSplitOptions() {
        WebBackendSplitContainerOptions options = ((WebBackendSplitContainerOptions) (super.createDefaultDrawerSplitOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreSplitContainer, ? extends CoreSplitContainerOptions> getTopAppBarSplitCreator() {
        return topAppBarSplitCreator;
    }

    public S setTopAppBarSplitCreator(ComponentCreator<? extends WebBackendSplitContainer, ? extends WebBackendSplitContainerOptions> topAppBarSplitCreator) {
        this.topAppBarSplitCreator = topAppBarSplitCreator;
        return self();
    }

    protected WebBackendSplitContainerOptions createDefaultTopAppBarSplitOptions() {
        WebBackendSplitContainerOptions options = ((WebBackendSplitContainerOptions) (super.createDefaultTopAppBarSplitOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreAppLayoutBody, ? extends CoreAppLayoutBodyOptions> getBodyCreator() {
        return bodyCreator;
    }

    public S setBodyCreator(ComponentCreator<? extends WebBackendAppLayoutBody, ? extends WebBackendAppLayoutBodyOptions> bodyCreator) {
        this.bodyCreator = bodyCreator;
        return self();
    }

    protected WebBackendAppLayoutBodyOptions createDefaultBodyOptions() {
        WebBackendAppLayoutBodyOptions options = ((WebBackendAppLayoutBodyOptions) (super.createDefaultBodyOptions()));
        return options;
    }
}
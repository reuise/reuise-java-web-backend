...
import dev.reuise.web.core.applayout.AbstractWebAppLayoutBodyOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendAppLayoutBodyOptions<S extends AbstractWebBackendAppLayoutBodyOptions<S>> extends AbstractWebAppLayoutBodyOptions<S> implements WebBackendAppLayoutBodyOptions {
    ...
    protected AbstractWebBackendAppLayoutBodyOptions() {
        this(null);
    }

    protected AbstractWebBackendAppLayoutBodyOptions(WebBackendFlexContainerOptions baseOptions) {
        flexContainerPart = (baseOptions != null) ? baseOptions : getComponentFactory().createFlexContainerOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-app-layout_body");
    ...
    @Override
    public WebBackendAppLayoutBody getComponent() {
        return ((WebBackendAppLayoutBody) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendAppLayoutBodyOptions) (other)) instanceof WebBackendAppLayoutBodyOptions) {
            WebBackendAppLayoutBodyOptions otherWebBackendAppLayoutBodyOptions = ((WebBackendAppLayoutBodyOptions) (other));
        }
    }
}
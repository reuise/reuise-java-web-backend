...
import dev.reuise.web.core.graphics.svg.AbstractWebSvgPathOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSvgPathOptions<S extends AbstractWebBackendSvgPathOptions<S>> extends AbstractWebSvgPathOptions<S> implements WebBackendSvgPathOptions {
    protected final WebBackendSvgShapePartOptions svgShapePart;

    protected final WebBackendSvgPartOptions svgPart;
    ...
    protected AbstractWebBackendSvgPathOptions() {
        this(null);
    }

    protected AbstractWebBackendSvgPathOptions(WebBackendSvgShapeOptions baseOptions) {
        svgShapePart = (baseOptions != null) ? baseOptions : getComponentFactory().createSvgShapeOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("path");
        setXmlNamespace("http://www.w3.org/2000/svg");
        return true;
    }
    ...
    public ComponentOption<String> getFillOption() {
        return svgShapePart.getFillOption();
    }
    ...
    public ComponentOption<String> getStrokeOption() {
        return svgShapePart.getStrokeOption();
    }
    ...
    public ComponentOption<Double> getStrokeWidthOption() {
        return svgShapePart.getStrokeWidthOption();
    }
    ...
    public WebBackendSvgShapePartOptions getSvgShapePart() {
        return svgShapePart;
    }
    ...
    @Override
    public ComponentOption<ClassResource> getSourceResourceOption() {
        return svgPart.getSourceResourceOption();
    }
    ...
    public ComponentOption<String> getViewBoxOption() {
        return svgPart.getViewBoxOption();
    }
    ...
    public WebBackendSvgPartOptions getSvgPart() {
        return svgPart;
    }
    ...
    @Override
    public WebBackendSvgPath getComponent() {
        return ((WebBackendSvgPath) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendSvgPathOptions) (other)) instanceof WebBackendSvgPathOptions) {
            WebBackendSvgPathOptions otherWebBackendSvgPathOptions = ((WebBackendSvgPathOptions) (other));
        }
    }
}
...
import dev.reuise.web.core.graphics.svg.AbstractWebSvgShapeOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSvgShapeOptions<S extends AbstractWebBackendSvgShapeOptions<S>> extends AbstractWebSvgShapeOptions<S> implements WebBackendSvgShapeOptions {
    ...
    protected AbstractWebBackendSvgShapeOptions() {
        this(null);
    }

    protected AbstractWebBackendSvgShapeOptions(WebBackendSvgOptions baseOptions) {
    ...
    @Override
    public WebBackendSvgShape getComponent() {
        return ((WebBackendSvgShape) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendSvgShapeOptions) (other)) instanceof WebBackendSvgShapeOptions) {
            WebBackendSvgShapeOptions otherWebBackendSvgShapeOptions = ((WebBackendSvgShapeOptions) (other));
        }
    }
}
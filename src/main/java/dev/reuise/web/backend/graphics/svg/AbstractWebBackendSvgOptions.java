...
import dev.reuise.web.core.graphics.svg.AbstractWebSvgOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSvgOptions<S extends AbstractWebBackendSvgOptions<S>> extends AbstractWebSvgOptions<S> implements WebBackendSvgOptions {
    ...
    protected AbstractWebBackendSvgOptions() {
        this(null);
    }

    protected AbstractWebBackendSvgOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendSvgOptions) (other)) instanceof WebBackendSvgOptions) {
            WebBackendSvgOptions otherWebBackendSvgOptions = ((WebBackendSvgOptions) (other));
        }
    }

    @Override
    public ClassResource getSourceResource() {
        return ((ClassResource) (getOptionValue("sourceResource")));
    }

    @Override
    public ComponentOption<ClassResource> getSourceResourceOption() {
        return ((ComponentOption<ClassResource>) (getOption("sourceResource")));
    }

    @Override
    public S setSourceResource(ClassResource sourceResource) {
        setOption("sourceResource", sourceResource);
        return self();
    }

    private void setDefaultSourceResource(ClassResource sourceResource) {
        setDefaultOption("sourceResource", sourceResource);
    }
}
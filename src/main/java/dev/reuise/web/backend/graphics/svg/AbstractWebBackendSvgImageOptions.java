...
import dev.reuise.web.core.graphics.svg.AbstractWebSvgImageOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSvgImageOptions<S extends AbstractWebBackendSvgImageOptions<S>> extends AbstractWebSvgImageOptions<S> implements WebBackendSvgImageOptions {
    ...
    protected AbstractWebBackendSvgImageOptions() {
        this(null);
    }

    protected AbstractWebBackendSvgImageOptions(WebBackendSvgOptions baseOptions) {
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendSvgImageOptions) (other)) instanceof WebBackendSvgImageOptions) {
            WebBackendSvgImageOptions otherWebBackendSvgImageOptions = ((WebBackendSvgImageOptions) (other));
        }
    }
}
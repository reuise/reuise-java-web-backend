...
import dev.reuise.web.core.graphics.svg.DefaultWebSvgTextPart;
...
public abstract class DefaultWebBackendSvgText<S extends DefaultWebBackendSvgText<S, O>, O extends WebBackendSvgTextOptions> extends DefaultWebSvgTextPart<S, O> implements WebBackendComponentType<S, O> , WebBackendSvgText {
    ...
    protected DefaultWebBackendSvgText(O options) {
        super(options);

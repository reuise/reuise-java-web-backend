...
import dev.reuise.web.core.graphics.svg.AbstractWebSvgGroupOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSvgGroupOptions<S extends AbstractWebBackendSvgGroupOptions<S>> extends AbstractWebSvgGroupOptions<S> implements WebBackendSvgGroupOptions {
    ...
    protected AbstractWebBackendSvgGroupOptions() {
        this(null);
    }

    protected AbstractWebBackendSvgGroupOptions(WebBackendSvgOptions baseOptions) {
        svgPart = (baseOptions != null) ? baseOptions : getComponentFactory().createSvgOptions();
    ...
    @Override
    public WebBackendSvgGroup getComponent() {
        return ((WebBackendSvgGroup) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendSvgGroupOptions) (other)) instanceof WebBackendSvgGroupOptions) {
            WebBackendSvgGroupOptions otherWebBackendSvgGroupOptions = ((WebBackendSvgGroupOptions) (other));
        }
    }
}
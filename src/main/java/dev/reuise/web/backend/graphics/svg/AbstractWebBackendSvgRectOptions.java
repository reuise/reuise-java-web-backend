...
import dev.reuise.web.core.graphics.svg.AbstractWebSvgRectOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSvgRectOptions<S extends AbstractWebBackendSvgRectOptions<S>> extends AbstractWebSvgRectOptions<S> implements WebBackendSvgRectOptions {
    ...
    protected AbstractWebBackendSvgRectOptions() {
        this(null);
    }

    protected AbstractWebBackendSvgRectOptions(WebBackendSvgShapeOptions baseOptions) {
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendSvgRectOptions) (other)) instanceof WebBackendSvgRectOptions) {
            WebBackendSvgRectOptions otherWebBackendSvgRectOptions = ((WebBackendSvgRectOptions) (other));
        }
    }
}
...
import dev.reuise.web.core.graphics.svg.AbstractWebSvgTextOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSvgTextOptions<S extends AbstractWebBackendSvgTextOptions<S>> extends AbstractWebSvgTextOptions<S> implements WebBackendSvgTextOptions {
    ...
    protected AbstractWebBackendSvgTextOptions() {
        this(null);
    }

    protected AbstractWebBackendSvgTextOptions(WebBackendSvgOptions baseOptions) {
    ...
    @Override
    public WebBackendSvgText getComponent() {
        return ((WebBackendSvgText) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendSvgTextOptions) (other)) instanceof WebBackendSvgTextOptions) {
            WebBackendSvgTextOptions otherWebBackendSvgTextOptions = ((WebBackendSvgTextOptions) (other));
        }
    }
}
...
import dev.reuise.web.core.media.AbstractWebTextTrackOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendTextTrackOptions<S extends AbstractWebBackendTextTrackOptions<S>> extends AbstractWebTextTrackOptions<S> implements WebBackendTextTrackOptions {
    ...
    protected AbstractWebBackendTextTrackOptions() {
        this(null);
    }

    protected AbstractWebBackendTextTrackOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("track");
        setBaseStyleClass("reuise-texttrack");
        return true;
    }
    ...
    @Override
    public WebBackendTextTrack getComponent() {
        return ((WebBackendTextTrack) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendTextTrackOptions) (other)) instanceof WebBackendTextTrackOptions) {
            WebBackendTextTrackOptions otherWebBackendTextTrackOptions = ((WebBackendTextTrackOptions) (other));
        }
    }
}
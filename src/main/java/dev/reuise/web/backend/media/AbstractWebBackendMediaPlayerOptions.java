...
import dev.reuise.web.core.media.AbstractWebMediaPlayerOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendMediaPlayerOptions<S extends AbstractWebBackendMediaPlayerOptions<S>> extends AbstractWebMediaPlayerOptions<S> implements WebBackendMediaPlayerOptions {
    ...
    protected AbstractWebBackendMediaPlayerOptions() {
        this(null);
    }

    protected AbstractWebBackendMediaPlayerOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-mediaplayer");
        return true;
    }
    ...
    @Override
    public WebBackendMediaPlayer getComponent() {
        return ((WebBackendMediaPlayer) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendMediaPlayerOptions) (other)) instanceof WebBackendMediaPlayerOptions) {
            WebBackendMediaPlayerOptions otherWebBackendMediaPlayerOptions = ((WebBackendMediaPlayerOptions) (other));
        }
    }
}
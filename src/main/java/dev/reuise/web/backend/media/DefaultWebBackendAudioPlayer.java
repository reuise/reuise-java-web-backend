...
import dev.reuise.web.core.media.DefaultWebAudioPlayerPart;
...
public abstract class DefaultWebBackendAudioPlayer<S extends DefaultWebBackendAudioPlayer<S, O>, O extends WebBackendAudioPlayerOptions> extends DefaultWebAudioPlayerPart<S, O> implements WebBackendAudioPlayer , WebBackendComponentType<S, O> {
    protected final WebBackendMediaPlayerPart mediaPlayerPart;
    ...
    protected DefaultWebBackendAudioPlayer(O options) {
        super(options);
        if (options.getComponent() == null)
            options.setComponent(self());

        mediaPlayerPart = options.getComponentFactory().createMediaPlayer(((CoreMediaPlayerOptions) (options.getMediaPlayerPart())));
        parentComponentPart = mediaPlayerPart.getParentComponentPart();
        baseComponentPart = parentComponentPart.getBaseComponentPart();
        addPart(ComponentPart.Type.BASE, mediaPlayerPart);
    }

    public WebBackendMediaPlayerPart getMediaPlayerPart() {

...
import dev.reuise.web.core.media.DefaultWebTextTrackPart;
...
public abstract class DefaultWebBackendTextTrack<S extends DefaultWebBackendTextTrack<S, O>, O extends WebBackendTextTrackOptions> extends DefaultWebTextTrackPart<S, O> implements WebBackendComponentType<S, O> , WebBackendTextTrack {
    ...
    protected DefaultWebBackendTextTrack(O options) {
        super(options);

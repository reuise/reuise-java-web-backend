...
import dev.reuise.web.core.media.AbstractWebAudioPlayerOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendAudioPlayerOptions<S extends AbstractWebBackendAudioPlayerOptions<S>> extends AbstractWebAudioPlayerOptions<S> implements WebBackendAudioPlayerOptions {
    protected final WebBackendMediaPlayerPartOptions mediaPlayerPart;
    ...
    protected AbstractWebBackendAudioPlayerOptions() {
        this(null);
    }

    protected AbstractWebBackendAudioPlayerOptions(WebBackendMediaPlayerOptions baseOptions) {
        mediaPlayerPart = (baseOptions != null) ? baseOptions : getComponentFactory().createMediaPlayerOptions();
        parentComponentPart = mediaPlayerPart.getParentComponentPart();
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("audio");
        setBaseStyleClass("reuise-audioplayer");
        return true;
    }
    ...
    public boolean isAutoplay() {
        return mediaPlayerPart.isAutoplay();
    }

    @Override
    public ComponentOption<Boolean> getAutoplayOption() {
        return mediaPlayerPart.getAutoplayOption();
    }

    @Override
    public S setAutoplay(Boolean autoplay) {
        this.mediaPlayerPart.setAutoplay(autoplay);
        return self();
    }

    @Override
    public boolean isControls() {
        return mediaPlayerPart.isControls();
    }

    @Override
    public ComponentOption<Boolean> getControlsOption() {
        return mediaPlayerPart.getControlsOption();
    }

    @Override
    public S setControls(Boolean controls) {
        this.mediaPlayerPart.setControls(controls);
        return self();
    }

    @Override
    public boolean isLoop() {
        return mediaPlayerPart.isLoop();
    }

    @Override
    public ComponentOption<Boolean> getLoopOption() {
        return mediaPlayerPart.getLoopOption();
    }

    @Override
    public S setLoop(Boolean loop) {
        this.mediaPlayerPart.setLoop(loop);
        return self();
    }

    @Override
    public boolean isMuted() {
        return mediaPlayerPart.isMuted();
    }

    @Override
    public ComponentOption<Boolean> getMutedOption() {
        return mediaPlayerPart.getMutedOption();
    }

    @Override
    public S setMuted(Boolean muted) {
        this.mediaPlayerPart.setMuted(muted);
        return self();
    }

    @Override
    public String getUrl() {
        return mediaPlayerPart.getUrl();
    }

    @Override
    public ComponentOption<String> getUrlOption() {
        return mediaPlayerPart.getUrlOption();
    }

    @Override
    public S setUrl(String url) {
        this.mediaPlayerPart.setUrl(url);
        return self();
    }

    @Override
    public List<CoreTextTrack> getTextTracks() {
        return mediaPlayerPart.getTextTracks();
    }

    @Override
    public ComponentOption<List<CoreTextTrack>> getTextTracksOption() {
        return mediaPlayerPart.getTextTracksOption();
    }

    @Override
    public S setTextTracks(List<CoreTextTrack> textTracks) {
        this.mediaPlayerPart.setTextTracks(textTracks);
        return self();
    }

    @Override
    public S addTextTrack(CoreTextTrack textTrack) {
        this.mediaPlayerPart.addTextTrack(textTrack);
        return self();
    }

    @Override
    public S removeTextTrack(CoreTextTrack textTrack) {
        mediaPlayerPart.removeTextTrack(textTrack);
        return self();
    }

    public WebBackendMediaPlayerPartOptions getMediaPlayerPart() {
        return mediaPlayerPart;
    }
    ...
    @Override
    public WebBackendAudioPlayer getComponent() {
        return ((WebBackendAudioPlayer) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendAudioPlayerOptions) (other)) instanceof WebBackendAudioPlayerOptions) {
            WebBackendAudioPlayerOptions otherWebBackendAudioPlayerOptions = ((WebBackendAudioPlayerOptions) (other));
        }
    }
}
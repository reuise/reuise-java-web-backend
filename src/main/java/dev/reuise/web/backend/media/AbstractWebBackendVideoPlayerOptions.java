...
import dev.reuise.web.core.media.AbstractWebVideoPlayerOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendVideoPlayerOptions<S extends AbstractWebBackendVideoPlayerOptions<S>> extends AbstractWebVideoPlayerOptions<S> implements WebBackendVideoPlayerOptions {
    ...
    protected AbstractWebBackendVideoPlayerOptions() {
        this(null);
    }

    protected AbstractWebBackendVideoPlayerOptions(WebBackendMediaPlayerOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("video");
        setBaseStyleClass("reuise-videoplayer");
        return true;
    }
    ...
    @Override
    public WebBackendVideoPlayer getComponent() {
        return ((WebBackendVideoPlayer) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendVideoPlayerOptions) (other)) instanceof WebBackendVideoPlayerOptions) {
            WebBackendVideoPlayerOptions otherWebBackendVideoPlayerOptions = ((WebBackendVideoPlayerOptions) (other));
        }
    }
}
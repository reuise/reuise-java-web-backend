...
import dev.reuise.web.core.media.DefaultWebMediaPlayerPart;
...
public abstract class DefaultWebBackendMediaPlayer<S extends DefaultWebBackendMediaPlayer<S, O>, O extends WebBackendMediaPlayerOptions> extends DefaultWebMediaPlayerPart<S, O> implements WebBackendComponentType<S, O> , WebBackendMediaPlayer {
    ...
    protected DefaultWebBackendMediaPlayer(O options) {
        super(options);

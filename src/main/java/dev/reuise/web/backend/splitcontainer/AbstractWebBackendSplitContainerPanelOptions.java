...
import dev.reuise.web.core.splitcontainer.AbstractWebSplitContainerPanelOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSplitContainerPanelOptions<S extends AbstractWebBackendSplitContainerPanelOptions<S>> extends AbstractWebSplitContainerPanelOptions<S> implements WebBackendSplitContainerPanelOptions {
    ...
    protected AbstractWebBackendSplitContainerPanelOptions() {
        this(null);
    }

    protected AbstractWebBackendSplitContainerPanelOptions(WebBackendContainerOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-splitcontainer_panel");
        setStoreInElementOptions(new ArrayList(Arrays.asList("collapsed", "size", "minSize", "maxSize", "direction")));
        return true;
    }
    ...
    @Override
    public WebBackendSplitContainerPanel getComponent() {
        return ((WebBackendSplitContainerPanel) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendSplitContainerPanelOptions) (other)) instanceof WebBackendSplitContainerPanelOptions) {
            WebBackendSplitContainerPanelOptions otherWebBackendSplitContainerPanelOptions = ((WebBackendSplitContainerPanelOptions) (other));
        }
    }
}
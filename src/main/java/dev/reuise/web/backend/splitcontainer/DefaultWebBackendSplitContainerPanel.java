...
import dev.reuise.web.core.splitcontainer.DefaultWebSplitContainerPanelPart;
...
public abstract class DefaultWebBackendSplitContainerPanel<S extends DefaultWebBackendSplitContainerPanel<S, O>, O extends WebBackendSplitContainerPanelOptions> extends DefaultWebSplitContainerPanelPart<S, O> implements WebBackendSplitContainerPanel , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendSplitContainerPanel(O options) {
        super(options);

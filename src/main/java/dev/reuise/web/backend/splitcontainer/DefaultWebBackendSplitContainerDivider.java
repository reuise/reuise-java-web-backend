...
import dev.reuise.web.core.splitcontainer.DefaultWebSplitContainerDividerPart;
...
public abstract class DefaultWebBackendSplitContainerDivider<S extends DefaultWebBackendSplitContainerDivider<S, O>, O extends WebBackendSplitContainerDividerOptions> extends DefaultWebSplitContainerDividerPart<S, O> implements WebBackendSplitContainerDivider , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendSplitContainerDivider(O options) {
        super(options);

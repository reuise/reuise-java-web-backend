...
import dev.reuise.web.core.splitcontainer.AbstractWebSplitContainerDividerOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSplitContainerDividerOptions<S extends AbstractWebBackendSplitContainerDividerOptions<S>> extends AbstractWebSplitContainerDividerOptions<S> implements WebBackendSplitContainerDividerOptions {
    ...
    protected AbstractWebBackendSplitContainerDividerOptions() {
        this(null);
    }

    protected AbstractWebBackendSplitContainerDividerOptions(WebBackendContainerOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-splitcontainer_divider");
        setStoreInElementOptions(new ArrayList(Arrays.asList("thickness")));
        return true;
    }
    ...
    @Override
    public WebBackendSplitContainerDivider getComponent() {
        return ((WebBackendSplitContainerDivider) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendSplitContainerDividerOptions) (other)) instanceof WebBackendSplitContainerDividerOptions) {
            WebBackendSplitContainerDividerOptions otherWebBackendSplitContainerDividerOptions = ((WebBackendSplitContainerDividerOptions) (other));
        }
    }
}
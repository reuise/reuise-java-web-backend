...
public abstract class DefaultWebBackendSplitContainer<S extends DefaultWebBackendSplitContainer<S, O>, O extends WebBackendSplitContainerOptions> extends DefaultWebSplitContainerPart<S, O> implements WebBackendComponentType<S, O> , WebBackendSplitContainer {
    ...
    protected DefaultWebBackendSplitContainer(O options) {
        super(options);
    ...
    public WebBackendSplitContainerPanel getStartPanel() {
        return ((WebBackendSplitContainerPanel) (super.getStartPanel()));
    }

    @Override
    public WebBackendSplitContainerDivider getDivider() {
        return ((WebBackendSplitContainerDivider) (super.getDivider()));
    }

    @Override
    public WebBackendSplitContainerPanel getEndPanel() {
        return ((WebBackendSplitContainerPanel) (super.getEndPanel()));
    }

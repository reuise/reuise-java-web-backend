...
import dev.reuise.web.core.link.AbstractWebLinkOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendLinkOptions<S extends AbstractWebBackendLinkOptions<S>> extends AbstractWebLinkOptions<S> implements WebBackendLinkOptions {
    ...
    protected AbstractWebBackendLinkOptions() {
        this(null);
    }

    protected AbstractWebBackendLinkOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    @Override
    public WebBackendLink getComponent() {
        return ((WebBackendLink) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendLinkOptions) (other)) instanceof WebBackendLinkOptions) {
            WebBackendLinkOptions otherWebBackendLinkOptions = ((WebBackendLinkOptions) (other));
        }
    }
}
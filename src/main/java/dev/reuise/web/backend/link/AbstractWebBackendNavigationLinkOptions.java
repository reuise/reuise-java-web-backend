...
import dev.reuise.web.core.link.AbstractWebNavigationLinkOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendNavigationLinkOptions<S extends AbstractWebBackendNavigationLinkOptions<S>> extends AbstractWebNavigationLinkOptions<S> implements WebBackendNavigationLinkOptions {
    protected final WebBackendLinkPartOptions linkPart;
    ...
    protected AbstractWebBackendNavigationLinkOptions() {
        this(null);
    }

    protected AbstractWebBackendNavigationLinkOptions(WebBackendLinkOptions baseOptions) {
        linkPart = (baseOptions != null) ? baseOptions : getComponentFactory().createLinkOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("a");
        setStyleClass("reuise-navigationlink");
        setStoreInElementOptions(new ArrayList(Arrays.asList("activeMatchType")));
        return true;
    }
    ...
    public ComponentOption<Boolean> getUseHistoryApiOption() {
        return linkPart.getUseHistoryApiOption();
    }
    ...
    public String getText() {
        return linkPart.getText();
    }

    @Override
    public ComponentOption<String> getTextOption() {
        return linkPart.getTextOption();
    }

    @Override
    public S setText(String text) {
        this.linkPart.setText(text);
        return self();
    }

    @Override
    public String getUrl() {
        return linkPart.getUrl();
    }

    @Override
    public ComponentOption<String> getUrlOption() {
        return linkPart.getUrlOption();
    }

    @Override
    public S setUrl(String url) {
        this.linkPart.setUrl(url);
        return self();
    }

    @Override
    public String getTarget() {
        return linkPart.getTarget();
    }

    @Override
    public ComponentOption<String> getTargetOption() {
        return linkPart.getTargetOption();
    }

    @Override
    public S setTarget(String target) {
        this.linkPart.setTarget(target);
        return self();
    }
    ...
    public WebBackendLinkPartOptions getLinkPart() {
        return linkPart;
    }
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendNavigationLinkOptions) (other)) instanceof WebBackendNavigationLinkOptions) {
            WebBackendNavigationLinkOptions otherWebBackendNavigationLinkOptions = ((WebBackendNavigationLinkOptions) (other));
        }
    }
}
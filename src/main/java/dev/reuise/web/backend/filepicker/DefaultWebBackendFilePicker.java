...
import dev.reuise.web.core.filepicker.DefaultWebFilePickerPart;
...
public abstract class DefaultWebBackendFilePicker<S extends DefaultWebBackendFilePicker<S, O>, O extends WebBackendFilePickerOptions> extends DefaultWebFilePickerPart<S, O> implements WebBackendComponentType<S, O> , WebBackendFilePicker {
    protected final WebBackendBaseComponentPart baseComponentPart;

    protected DefaultWebBackendFilePicker(O options) {
        super(options);

...
import dev.reuise.web.core.filepicker.AbstractWebFilePickerOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendFilePickerOptions<S extends AbstractWebBackendFilePickerOptions<S>> extends AbstractWebFilePickerOptions<S> implements WebBackendFilePickerOptions {
    protected final WebBackendBaseComponentPartOptions baseComponentPart;

    protected AbstractWebBackendFilePickerOptions() {
        this(null);
    }

    protected AbstractWebBackendFilePickerOptions(WebBackendBaseComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("input");
        setBaseStyleClass("reuise-filepicker");
        return true;
    }
    ...
    @Override
    public WebBackendFilePicker getComponent() {
        return ((WebBackendFilePicker) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendFilePickerOptions) (other)) instanceof WebBackendFilePickerOptions) {
            WebBackendFilePickerOptions otherWebBackendFilePickerOptions = ((WebBackendFilePickerOptions) (other));
        }
    }
}
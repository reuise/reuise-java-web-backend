...
import dev.reuise.web.core.dialog.AbstractWebDialogOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendDialogOptions<S extends AbstractWebBackendDialogOptions<S>> extends AbstractWebDialogOptions<S> implements WebBackendDialogOptions {
    ...
    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> headerCreator;

    protected ComponentCreator<? extends CoreHeading, ? extends CoreHeadingOptions> titleHeadingCreator;

    protected ComponentCreator<? extends CoreFlexContainer, ? extends CoreFlexContainerOptions> bodyCreator;

    protected ComponentCreator<? extends CoreFlexContainer, ? extends CoreFlexContainerOptions> footerCreator;

    protected ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> scrimCreator;

    protected ComponentCreator<? extends CoreButton, ? extends CoreButtonOptions> acceptButtonCreator;

    protected ComponentCreator<? extends CoreButton, ? extends CoreButtonOptions> cancelButtonCreator;

    protected AbstractWebBackendDialogOptions() {
        this(null);
    }

    protected AbstractWebBackendDialogOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-dialog");
        setStoreInElementOptions(new ArrayList(Arrays.asList("hasAcceptButton", "hasCancelButton")));
        return true;
    }
    ...
    @Override
    public WebBackendDialog getComponent() {
        return ((WebBackendDialog) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendDialogOptions) (other)) instanceof WebBackendDialogOptions) {
            WebBackendDialogOptions otherWebBackendDialogOptions = ((WebBackendDialogOptions) (other));
            CoreContainerOptions otherContainerOptions = otherWebBackendDialogOptions.getContainerOptions();
            if (otherContainerOptions != null)
                setContainerOptions(otherContainerOptions);

            CoreContainerOptions otherHeaderOptions = otherWebBackendDialogOptions.getHeaderOptions();
            if (otherHeaderOptions != null)
                setHeaderOptions(otherHeaderOptions);

            CoreHeadingOptions otherTitleHeadingOptions = otherWebBackendDialogOptions.getTitleHeadingOptions();
            if (otherTitleHeadingOptions != null)
                setTitleHeadingOptions(otherTitleHeadingOptions);

            CoreFlexContainerOptions otherBodyOptions = otherWebBackendDialogOptions.getBodyOptions();
            if (otherBodyOptions != null)
                setBodyOptions(otherBodyOptions);

            CoreFlexContainerOptions otherFooterOptions = otherWebBackendDialogOptions.getFooterOptions();
            if (otherFooterOptions != null)
                setFooterOptions(otherFooterOptions);

            CoreContainerOptions otherScrimOptions = otherWebBackendDialogOptions.getScrimOptions();
            if (otherScrimOptions != null)
                setScrimOptions(otherScrimOptions);

            CoreButtonOptions otherAcceptButtonOptions = otherWebBackendDialogOptions.getAcceptButtonOptions();
            if (otherAcceptButtonOptions != null)
                setAcceptButtonOptions(otherAcceptButtonOptions);

            CoreButtonOptions otherCancelButtonOptions = otherWebBackendDialogOptions.getCancelButtonOptions();
            if (otherCancelButtonOptions != null)
                setCancelButtonOptions(otherCancelButtonOptions);
    ...
    protected WebBackendContainerOptions createDefaultHeaderOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultHeaderOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreHeading, ? extends CoreHeadingOptions> getTitleHeadingCreator() {
        return titleHeadingCreator;
    }
    ...
    public S setTitleHeadingCreator(ComponentCreator<? extends WebBackendHeading, ? extends WebBackendHeadingOptions> titleHeadingCreator) {
        this.titleHeadingCreator = titleHeadingCreator;
        return self();
    }

    protected WebBackendHeadingOptions createDefaultTitleHeadingOptions() {
        WebBackendHeadingOptions options = ((WebBackendHeadingOptions) (super.createDefaultTitleHeadingOptions()));
        return options;
    }
    ...
    protected WebBackendFlexContainerOptions createDefaultBodyOptions() {
        WebBackendFlexContainerOptions options = ((WebBackendFlexContainerOptions) (super.createDefaultBodyOptions()));
        return options;
    }
    ...
    protected WebBackendFlexContainerOptions createDefaultFooterOptions() {
        WebBackendFlexContainerOptions options = ((WebBackendFlexContainerOptions) (super.createDefaultFooterOptions()));
        return options;
    }
    ...
    public S setScrimCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> scrimCreator) {
        this.scrimCreator = scrimCreator;
        return self();
    }

    protected WebBackendContainerOptions createDefaultScrimOptions() {
        WebBackendContainerOptions options = ((WebBackendContainerOptions) (super.createDefaultScrimOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreButton, ? extends CoreButtonOptions> getAcceptButtonCreator() {
        return acceptButtonCreator;
    }
    ...
    public S setAcceptButtonCreator(ComponentCreator<? extends WebBackendButton, ? extends WebBackendButtonOptions> acceptButtonCreator) {
        this.acceptButtonCreator = acceptButtonCreator;
        return self();
    }

    protected WebBackendButtonOptions createDefaultAcceptButtonOptions() {
        WebBackendButtonOptions options = ((WebBackendButtonOptions) (super.createDefaultAcceptButtonOptions()));
        return options;
    }

    public ComponentCreator<? extends CoreButton, ? extends CoreButtonOptions> getCancelButtonCreator() {
        return cancelButtonCreator;
    }
    ...
    public S setCancelButtonCreator(ComponentCreator<? extends WebBackendButton, ? extends WebBackendButtonOptions> cancelButtonCreator) {
        this.cancelButtonCreator = cancelButtonCreator;
        return self();
    }

    protected WebBackendButtonOptions createDefaultCancelButtonOptions() {
        WebBackendButtonOptions options = ((WebBackendButtonOptions) (super.createDefaultCancelButtonOptions()));
        return options;
    }
}
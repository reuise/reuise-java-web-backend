...
import dev.reuise.web.core.dialog.AbstractWebMessageDialogOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendMessageDialogOptions<S extends AbstractWebBackendMessageDialogOptions<S>> extends AbstractWebMessageDialogOptions<S> implements WebBackendMessageDialogOptions {
    protected final WebBackendDialogPartOptions dialogPart;
    ...
    protected AbstractWebBackendMessageDialogOptions() {
        this(null);
    }

    protected AbstractWebBackendMessageDialogOptions(WebBackendDialogOptions baseOptions) {
        dialogPart = (baseOptions != null) ? baseOptions : getComponentFactory().createDialogOptions();
    ...
    @Override
    public S setSize(ScreenSizeValues<DialogSize> size) {
        this.dialogPart.setSize(size);
        return self();
    }
    ...
    public ComponentOption<Boolean> getHasAcceptButtonOption() {
        return dialogPart.getHasAcceptButtonOption();
    }

    @Override
    public S setHasAcceptButton(Boolean hasAcceptButton) {
        this.dialogPart.setHasAcceptButton(hasAcceptButton);
        return self();
    }

    @Override
    public boolean isHasCancelButton() {
        return dialogPart.isHasCancelButton();
    }

    @Override
    public ComponentOption<Boolean> getHasCancelButtonOption() {
        return dialogPart.getHasCancelButtonOption();
    }

    @Override
    public S setHasCancelButton(Boolean hasCancelButton) {
        this.dialogPart.setHasCancelButton(hasCancelButton);
        return self();
    }

    @Override
    public CoreContainerOptions getContainerOptions() {
        return dialogPart.getContainerOptions();
    }

    @Override
    public S setContainerOptions(CoreContainerOptions containerOptions) {
        this.dialogPart.setContainerOptions(containerOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getContainerCreator() {
        return dialogPart.getContainerCreator();
    }
    ...
    public S setContainerCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> containerCreator) {
        this.dialogPart.setContainerCreator(containerCreator);
        return self();
    }

    @Override
    public boolean hasContainerOptions() {
        return dialogPart.hasContainerOptions();
    }

    @Override
    public CoreContainerOptions getHeaderOptions() {
        return dialogPart.getHeaderOptions();
    }

    @Override
    public S setHeaderOptions(CoreContainerOptions headerOptions) {
        this.dialogPart.setHeaderOptions(headerOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getHeaderCreator() {
        return dialogPart.getHeaderCreator();
    }

    @Override
    public S setHeaderCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> headerCreator) {
        this.dialogPart.setHeaderCreator(headerCreator);
        return self();
    }

    @Override
    public boolean hasHeaderOptions() {
        return dialogPart.hasHeaderOptions();
    }

    @Override
    public CoreHeadingOptions getTitleHeadingOptions() {
        return dialogPart.getTitleHeadingOptions();
    }

    @Override
    public S setTitleHeadingOptions(CoreHeadingOptions titleHeadingOptions) {
        this.dialogPart.setTitleHeadingOptions(titleHeadingOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreHeading, ? extends CoreHeadingOptions> getTitleHeadingCreator() {
        return dialogPart.getTitleHeadingCreator();
    }

    @Override
    public S setTitleHeadingCreator(ComponentCreator<? extends WebBackendHeading, ? extends WebBackendHeadingOptions> titleHeadingCreator) {
        this.dialogPart.setTitleHeadingCreator(titleHeadingCreator);
        return self();
    }

    @Override
    public boolean hasTitleHeadingOptions() {
        return dialogPart.hasTitleHeadingOptions();
    }

    @Override
    public CoreFlexContainerOptions getBodyOptions() {
        return dialogPart.getBodyOptions();
    }

    @Override
    public S setBodyOptions(CoreFlexContainerOptions bodyOptions) {
        this.dialogPart.setBodyOptions(bodyOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreFlexContainer, ? extends CoreFlexContainerOptions> getBodyCreator() {
        return dialogPart.getBodyCreator();
    }

    @Override
    public S setBodyCreator(ComponentCreator<? extends WebBackendFlexContainer, ? extends WebBackendFlexContainerOptions> bodyCreator) {
        this.dialogPart.setBodyCreator(bodyCreator);
        return self();
    }

    @Override
    public boolean hasBodyOptions() {
        return dialogPart.hasBodyOptions();
    }

    @Override
    public CoreFlexContainerOptions getFooterOptions() {
        return dialogPart.getFooterOptions();
    }

    @Override
    public S setFooterOptions(CoreFlexContainerOptions footerOptions) {
        this.dialogPart.setFooterOptions(footerOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreFlexContainer, ? extends CoreFlexContainerOptions> getFooterCreator() {
        return dialogPart.getFooterCreator();
    }

    @Override
    public S setFooterCreator(ComponentCreator<? extends WebBackendFlexContainer, ? extends WebBackendFlexContainerOptions> footerCreator) {
        this.dialogPart.setFooterCreator(footerCreator);
        return self();
    }

    @Override
    public boolean hasFooterOptions() {
        return dialogPart.hasFooterOptions();
    }

    @Override
    public CoreContainerOptions getScrimOptions() {
        return dialogPart.getScrimOptions();
    }

    @Override
    public S setScrimOptions(CoreContainerOptions scrimOptions) {
        this.dialogPart.setScrimOptions(scrimOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getScrimCreator() {
        return dialogPart.getScrimCreator();
    }

    @Override
    public S setScrimCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> scrimCreator) {
        this.dialogPart.setScrimCreator(scrimCreator);
        return self();
    }

    @Override
    public boolean hasScrimOptions() {
        return dialogPart.hasScrimOptions();
    }

    @Override
    public CoreButtonOptions getAcceptButtonOptions() {
        return dialogPart.getAcceptButtonOptions();
    }

    @Override
    public S setAcceptButtonOptions(CoreButtonOptions acceptButtonOptions) {
        this.dialogPart.setAcceptButtonOptions(acceptButtonOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreButton, ? extends CoreButtonOptions> getAcceptButtonCreator() {
        return dialogPart.getAcceptButtonCreator();
    }

    @Override
    public S setAcceptButtonCreator(ComponentCreator<? extends WebBackendButton, ? extends WebBackendButtonOptions> acceptButtonCreator) {
        this.dialogPart.setAcceptButtonCreator(acceptButtonCreator);
        return self();
    }

    @Override
    public boolean hasAcceptButtonOptions() {
        return dialogPart.hasAcceptButtonOptions();
    }

    @Override
    public CoreButtonOptions getCancelButtonOptions() {
        return dialogPart.getCancelButtonOptions();
    }

    @Override
    public S setCancelButtonOptions(CoreButtonOptions cancelButtonOptions) {
        this.dialogPart.setCancelButtonOptions(cancelButtonOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreButton, ? extends CoreButtonOptions> getCancelButtonCreator() {
        return dialogPart.getCancelButtonCreator();
    }

    @Override
    public S setCancelButtonCreator(ComponentCreator<? extends WebBackendButton, ? extends WebBackendButtonOptions> cancelButtonCreator) {
        this.dialogPart.setCancelButtonCreator(cancelButtonCreator);
        return self();
    }

    @Override
    public boolean hasCancelButtonOptions() {
        return dialogPart.hasCancelButtonOptions();
    }

    public WebBackendDialogPartOptions getDialogPart() {
        return dialogPart;
    }
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendMessageDialogOptions) (other)) instanceof WebBackendMessageDialogOptions) {
            WebBackendMessageDialogOptions otherWebBackendMessageDialogOptions = ((WebBackendMessageDialogOptions) (other));
        }
    }
}
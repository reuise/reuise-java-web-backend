...
import dev.reuise.web.core.dialog.DefaultWebDialogPart;
...
public abstract class DefaultWebBackendDialog<S extends DefaultWebBackendDialog<S, O>, O extends WebBackendDialogOptions> extends DefaultWebDialogPart<S, O> implements WebBackendComponentType<S, O> , WebBackendDialog {
    ...
    protected DefaultWebBackendDialog(O options) {
        super(options);
    ...
    public WebBackendContainer getContainer() {
        return ((WebBackendContainer) (super.getContainer()));
    }

    @Override
    public WebBackendContainer getHeader() {
        return ((WebBackendContainer) (super.getHeader()));
    }

    @Override
    public WebBackendHeading getTitleHeading() {
        return ((WebBackendHeading) (super.getTitleHeading()));
    }

    @Override
    public WebBackendFlexContainer getBody() {
        return ((WebBackendFlexContainer) (super.getBody()));
    }

    @Override
    public WebBackendFlexContainer getFooter() {
        return ((WebBackendFlexContainer) (super.getFooter()));
    }

    @Override
    public WebBackendContainer getScrim() {
        return ((WebBackendContainer) (super.getScrim()));
    }

    @Override
    public WebBackendButton getAcceptButton() {
        return ((WebBackendButton) (super.getAcceptButton()));
    }

    @Override
    public WebBackendButton getCancelButton() {
        return ((WebBackendButton) (super.getCancelButton()));
    }
    ...
    public S addAction(CoreButton action) {
        if (this.actions == null) {
            setActions(new ArrayList<CoreButton>());
        }

...
import dev.reuise.web.core.layout.AbstractWebFlexContainerOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendFlexContainerOptions<S extends AbstractWebBackendFlexContainerOptions<S>> extends AbstractWebFlexContainerOptions<S> implements WebBackendFlexContainerOptions {
    ...
    protected AbstractWebBackendFlexContainerOptions() {
        this(null);
    }

    protected AbstractWebBackendFlexContainerOptions(WebBackendContainerOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-flexcontainer");
        return true;
    }
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendFlexContainerOptions) (other)) instanceof WebBackendFlexContainerOptions) {
            WebBackendFlexContainerOptions otherWebBackendFlexContainerOptions = ((WebBackendFlexContainerOptions) (other));
        }
    }
}
...
import dev.reuise.web.core.layout.AbstractWebSheetLayoutOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSheetLayoutOptions<S extends AbstractWebBackendSheetLayoutOptions<S>> extends AbstractWebSheetLayoutOptions<S> implements WebBackendSheetLayoutOptions {
    ...
    protected AbstractWebBackendSheetLayoutOptions() {
        this(null);
    }

    protected AbstractWebBackendSheetLayoutOptions(WebBackendSplitContainerOptions baseOptions) {
        splitContainerPart = (baseOptions != null) ? baseOptions : getComponentFactory().createSplitContainerOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setStyleClass("reuise-sheetlayout");
        return true;
    }
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendSheetLayoutOptions) (other)) instanceof WebBackendSheetLayoutOptions) {
            WebBackendSheetLayoutOptions otherWebBackendSheetLayoutOptions = ((WebBackendSheetLayoutOptions) (other));
        }
    }
}
...
import dev.reuise.web.core.layout.AbstractWebColumnLayoutOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendColumnLayoutOptions<S extends AbstractWebBackendColumnLayoutOptions<S>> extends AbstractWebColumnLayoutOptions<S> implements WebBackendColumnLayoutOptions {
    ...
    protected AbstractWebBackendColumnLayoutOptions() {
        this(null);
    }

    protected AbstractWebBackendColumnLayoutOptions(WebBackendFlexContainerOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setStyleClass("reuise-columnlayout");
    ...
    @Override
    public WebBackendColumnLayout getComponent() {
        return ((WebBackendColumnLayout) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendColumnLayoutOptions) (other)) instanceof WebBackendColumnLayoutOptions) {
            WebBackendColumnLayoutOptions otherWebBackendColumnLayoutOptions = ((WebBackendColumnLayoutOptions) (other));
        }
    }
}
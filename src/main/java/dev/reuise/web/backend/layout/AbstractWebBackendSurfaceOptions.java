...
import dev.reuise.web.core.layout.AbstractWebSurfaceOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSurfaceOptions<S extends AbstractWebBackendSurfaceOptions<S>> extends AbstractWebSurfaceOptions<S> implements WebBackendSurfaceOptions {
    ...
    protected AbstractWebBackendSurfaceOptions() {
        this(null);
    }

    protected AbstractWebBackendSurfaceOptions(WebBackendFlexContainerOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setBaseStyleClass("reuise-surface");
    ...
    @Override
    public WebBackendSurface getComponent() {
        return ((WebBackendSurface) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendSurfaceOptions) (other)) instanceof WebBackendSurfaceOptions) {
            WebBackendSurfaceOptions otherWebBackendSurfaceOptions = ((WebBackendSurfaceOptions) (other));
        }
    }
}
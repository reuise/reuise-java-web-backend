...
import dev.reuise.web.core.layout.AbstractWebFieldSetOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendFieldSetOptions<S extends AbstractWebBackendFieldSetOptions<S>> extends AbstractWebFieldSetOptions<S> implements WebBackendFieldSetOptions {
    ...
    protected AbstractWebBackendFieldSetOptions() {
        this(null);
    }

    protected AbstractWebBackendFieldSetOptions(WebBackendContainerOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("fieldset");
        setBaseStyleClass("reuise-fieldset");
        return true;
    }
    ...
    @Override
    public WebBackendFieldSet getComponent() {
        return ((WebBackendFieldSet) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendFieldSetOptions) (other)) instanceof WebBackendFieldSetOptions) {
            WebBackendFieldSetOptions otherWebBackendFieldSetOptions = ((WebBackendFieldSetOptions) (other));
        }
    }
}
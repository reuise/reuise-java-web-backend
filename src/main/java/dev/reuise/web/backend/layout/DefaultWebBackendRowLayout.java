...
import dev.reuise.web.core.layout.DefaultWebRowLayoutPart;
...
public abstract class DefaultWebBackendRowLayout<S extends DefaultWebBackendRowLayout<S, O>, O extends WebBackendRowLayoutOptions> extends DefaultWebRowLayoutPart<S, O> implements WebBackendRowLayout , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendRowLayout(O options) {
        super(options);

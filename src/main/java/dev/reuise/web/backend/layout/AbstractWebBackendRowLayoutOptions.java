...
import dev.reuise.web.core.layout.AbstractWebRowLayoutOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendRowLayoutOptions<S extends AbstractWebBackendRowLayoutOptions<S>> extends AbstractWebRowLayoutOptions<S> implements WebBackendRowLayoutOptions {
    ...
    protected AbstractWebBackendRowLayoutOptions() {
        this(null);
    }

    protected AbstractWebBackendRowLayoutOptions(WebBackendFlexContainerOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("div");
        setStyleClass("reuise-rowlayout");
    ...
    @Override
    public WebBackendRowLayout getComponent() {
        return ((WebBackendRowLayout) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendRowLayoutOptions) (other)) instanceof WebBackendRowLayoutOptions) {
            WebBackendRowLayoutOptions otherWebBackendRowLayoutOptions = ((WebBackendRowLayoutOptions) (other));
        }
    }
}
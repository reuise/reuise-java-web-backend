...
import dev.reuise.web.core.layout.AbstractWebContainerOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendContainerOptions<S extends AbstractWebBackendContainerOptions<S>> extends AbstractWebContainerOptions<S> implements WebBackendContainerOptions {
    ...
    protected AbstractWebBackendContainerOptions() {
        this(null);
    }

    protected AbstractWebBackendContainerOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-container");
        return true;
    }
    ...
    @Override
    public WebBackendContainer getComponent() {
        return ((WebBackendContainer) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendContainerOptions) (other)) instanceof WebBackendContainerOptions) {
            WebBackendContainerOptions otherWebBackendContainerOptions = ((WebBackendContainerOptions) (other));
        }
    }
}
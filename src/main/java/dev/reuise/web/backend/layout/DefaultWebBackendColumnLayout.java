...
import dev.reuise.web.core.layout.DefaultWebColumnLayoutPart;
...
public abstract class DefaultWebBackendColumnLayout<S extends DefaultWebBackendColumnLayout<S, O>, O extends WebBackendColumnLayoutOptions> extends DefaultWebColumnLayoutPart<S, O> implements WebBackendColumnLayout , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendColumnLayout(O options) {
        super(options);

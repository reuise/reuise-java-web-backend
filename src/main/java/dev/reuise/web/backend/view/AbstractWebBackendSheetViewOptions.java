...
import dev.reuise.web.core.view.AbstractWebSheetViewOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSheetViewOptions<S extends AbstractWebBackendSheetViewOptions<S>> extends AbstractWebSheetViewOptions<S> implements WebBackendSheetViewOptions {
    protected final WebBackendViewPartOptions viewPart;
    ...
    protected AbstractWebBackendSheetViewOptions() {
        this(null);
    }

    protected AbstractWebBackendSheetViewOptions(WebBackendViewOptions baseOptions) {
        viewPart = (baseOptions != null) ? baseOptions : getComponentFactory().createViewOptions();
        flexContainerPart = viewPart.getFlexContainerPart();
    ...
    public ComponentOption<Map<String, String>> getParametersOption() {
        return viewPart.getParametersOption();
    }
    ...
    public ComponentOption<String> getContentTypeOption() {
        return viewPart.getContentTypeOption();
    }
    ...
    public ComponentOption<String> getTitleOption() {
        return viewPart.getTitleOption();
    }
    ...
    public WebBackendViewPartOptions getViewPart() {
        return viewPart;
    }
    ...
    @Override
    public WebBackendSheetView getComponent() {
        return ((WebBackendSheetView) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendSheetViewOptions) (other)) instanceof WebBackendSheetViewOptions) {
            WebBackendSheetViewOptions otherWebBackendSheetViewOptions = ((WebBackendSheetViewOptions) (other));
        }
    }
}
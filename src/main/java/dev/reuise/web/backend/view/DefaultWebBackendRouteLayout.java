...
import dev.reuise.web.core.view.DefaultWebRouteLayoutPart;
...
public abstract class DefaultWebBackendRouteLayout<S extends DefaultWebBackendRouteLayout<S, O>, O extends WebBackendRouteLayoutOptions> extends DefaultWebRouteLayoutPart<S, O> implements WebBackendRouteLayout , WebBackendComponentType<S, O> {
    ...
    protected DefaultWebBackendRouteLayout(O options) {
        super(options);
    ...
    public void setRootComponent(RootComponent rootComponent) {
        ...
        WebRootComponent webRootComponent = ((WebRootComponent) (rootComponent));
        setUrl(webRootComponent.getUrl());
    }
    ...
    public void onCreate(O options) {
        // Add routes
        List<RouteOptions> routes = options.getRoutes();
        if (routes != null)
            routes.forEach(r -> reveal(r, false, true));

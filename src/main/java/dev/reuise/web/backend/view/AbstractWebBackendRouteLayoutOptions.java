...
import dev.reuise.web.core.view.AbstractWebRouteLayoutOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendRouteLayoutOptions<S extends AbstractWebBackendRouteLayoutOptions<S>> extends AbstractWebRouteLayoutOptions<S> implements WebBackendRouteLayoutOptions {
    ...
    protected AbstractWebBackendRouteLayoutOptions() {
        this(null);
    }

    protected AbstractWebBackendRouteLayoutOptions(WebBackendContainerOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-routelayout");
        return true;
    }
    ...
    @Override
    public WebBackendRouteLayout getComponent() {
        return ((WebBackendRouteLayout) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendRouteLayoutOptions) (other)) instanceof WebBackendRouteLayoutOptions) {
            WebBackendRouteLayoutOptions otherWebBackendRouteLayoutOptions = ((WebBackendRouteLayoutOptions) (other));
        }
    }
}
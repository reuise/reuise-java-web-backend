...
import dev.reuise.web.core.view.AbstractWebSheetRouteLayoutOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendSheetRouteLayoutOptions<S extends AbstractWebBackendSheetRouteLayoutOptions<S>> extends AbstractWebSheetRouteLayoutOptions<S> implements WebBackendSheetRouteLayoutOptions {
    protected final WebBackendSheetLayoutPartOptions sheetLayoutPart;

    protected final WebBackendSplitContainerPartOptions splitContainerPart;
    ...
    protected ComponentCreator<? extends WebRouteLayout, ? extends WebRouteLayoutOptions> routeLayoutCreator;

    protected AbstractWebBackendSheetRouteLayoutOptions() {
        this(null);
    }

    protected AbstractWebBackendSheetRouteLayoutOptions(WebBackendSheetLayoutOptions baseOptions) {
        sheetLayoutPart = (baseOptions != null) ? baseOptions : getComponentFactory().createSheetLayoutOptions();
    ...
    public boolean onPreInitialize() {
        ...
        setBaseStyleClass("reuise-sheetroutelayout");
        return true;
    }
    ...
    public WebBackendSheetLayoutPartOptions getSheetLayoutPart() {
    ...
    public ComponentOption<SplitDirection> getDirectionOption() {
        return splitContainerPart.getDirectionOption();
    }
    ...
    public ComponentOption<SplitDirection> getDirectionOption(State state) {
        return splitContainerPart.getDirectionOption(state);
    }

    @Override
    public Collection<State> getDirectionStates() {
        return splitContainerPart.getDirectionStates();
    }
    ...
    public ComponentOption<Boolean> getReverseDirectionOption() {
        return splitContainerPart.getReverseDirectionOption();
    }
    ...
    public ComponentOption<Boolean> getReverseDirectionOption(State state) {
        return splitContainerPart.getReverseDirectionOption(state);
    }

    @Override
    public Collection<State> getReverseDirectionStates() {
        return splitContainerPart.getReverseDirectionStates();
    }

    public boolean isReverseDirectionAnyState() {
        return splitContainerPart.isReverseDirectionAnyState();
    }
    ...
    public ComponentOption<Boolean> getResizableOption() {
        return splitContainerPart.getResizableOption();
    }
    ...
    public ComponentOption<Object> getSplitPositionOption() {
        return splitContainerPart.getSplitPositionOption();
    }
    ...
    public ComponentOption<Object> getSplitPositionOption(State state) {
        return splitContainerPart.getSplitPositionOption(state);
    }

    @Override
    public Collection<State> getSplitPositionStates() {
        return splitContainerPart.getSplitPositionStates();
    }
    ...
    public ComponentOption<Object> getMinSplitPositionOption() {
        return splitContainerPart.getMinSplitPositionOption();
    }
    ...
    public ComponentOption<Object> getMinSplitPositionOption(State state) {
        return splitContainerPart.getMinSplitPositionOption(state);
    }

    @Override
    public Collection<State> getMinSplitPositionStates() {
        return splitContainerPart.getMinSplitPositionStates();
    }
    ...
    public ComponentOption<Object> getMaxSplitPositionOption() {
        return splitContainerPart.getMaxSplitPositionOption();
    }
    ...
    public ComponentOption<Object> getMaxSplitPositionOption(State state) {
        return splitContainerPart.getMaxSplitPositionOption(state);
    }

    @Override
    public Collection<State> getMaxSplitPositionStates() {
        return splitContainerPart.getMaxSplitPositionStates();
    }

    @Override
    public CoreContainerOptions getContainerOptions() {
        return splitContainerPart.getContainerOptions();
    }

    @Override
    public S setContainerOptions(CoreContainerOptions containerOptions) {
        this.splitContainerPart.setContainerOptions(containerOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreContainer, ? extends CoreContainerOptions> getContainerCreator() {
        return splitContainerPart.getContainerCreator();
    }
    ...
    public S setContainerCreator(ComponentCreator<? extends WebBackendContainer, ? extends WebBackendContainerOptions> containerCreator) {
        this.splitContainerPart.setContainerCreator(containerCreator);
        return self();
    }

    @Override
    public boolean hasContainerOptions() {
        return splitContainerPart.hasContainerOptions();
    }

    @Override
    public CoreSplitContainerPanelOptions getStartPanelOptions() {
        return splitContainerPart.getStartPanelOptions();
    }

    @Override
    public S setStartPanelOptions(CoreSplitContainerPanelOptions startPanelOptions) {
        this.splitContainerPart.setStartPanelOptions(startPanelOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreSplitContainerPanel, ? extends CoreSplitContainerPanelOptions> getStartPanelCreator() {
        return splitContainerPart.getStartPanelCreator();
    }
    ...
    public S setStartPanelCreator(ComponentCreator<? extends WebBackendSplitContainerPanel, ? extends WebBackendSplitContainerPanelOptions> startPanelCreator) {
        this.splitContainerPart.setStartPanelCreator(startPanelCreator);
        return self();
    }

    @Override
    public boolean hasStartPanelOptions() {
        return splitContainerPart.hasStartPanelOptions();
    }

    @Override
    public CoreSplitContainerDividerOptions getDividerOptions() {
        return splitContainerPart.getDividerOptions();
    }

    @Override
    public S setDividerOptions(CoreSplitContainerDividerOptions dividerOptions) {
        this.splitContainerPart.setDividerOptions(dividerOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreSplitContainerDivider, ? extends CoreSplitContainerDividerOptions> getDividerCreator() {
        return splitContainerPart.getDividerCreator();
    }
    ...
    public S setDividerCreator(ComponentCreator<? extends WebBackendSplitContainerDivider, ? extends WebBackendSplitContainerDividerOptions> dividerCreator) {
        this.splitContainerPart.setDividerCreator(dividerCreator);
        return self();
    }

    @Override
    public boolean hasDividerOptions() {
        return splitContainerPart.hasDividerOptions();
    }

    @Override
    public CoreSplitContainerPanelOptions getEndPanelOptions() {
        return splitContainerPart.getEndPanelOptions();
    }

    @Override
    public S setEndPanelOptions(CoreSplitContainerPanelOptions endPanelOptions) {
        this.splitContainerPart.setEndPanelOptions(endPanelOptions);
        return self();
    }

    @Override
    public ComponentCreator<? extends CoreSplitContainerPanel, ? extends CoreSplitContainerPanelOptions> getEndPanelCreator() {
        return splitContainerPart.getEndPanelCreator();
    }
    ...
    public S setEndPanelCreator(ComponentCreator<? extends WebBackendSplitContainerPanel, ? extends WebBackendSplitContainerPanelOptions> endPanelCreator) {
        this.splitContainerPart.setEndPanelCreator(endPanelCreator);
        return self();
    }

    @Override
    public boolean hasEndPanelOptions() {
        return splitContainerPart.hasEndPanelOptions();
    }

    public WebBackendSplitContainerPartOptions getSplitContainerPart() {
    ...
    public void merge(CoreComponentOptions other) {
        ...
        if (((WebBackendSheetRouteLayoutOptions) (other)) instanceof WebBackendSheetRouteLayoutOptions) {
            WebBackendSheetRouteLayoutOptions otherWebBackendSheetRouteLayoutOptions = ((WebBackendSheetRouteLayoutOptions) (other));
            WebRouteLayoutOptions otherRouteLayoutOptions = otherWebBackendSheetRouteLayoutOptions.getRouteLayoutOptions();
            if (otherRouteLayoutOptions != null)
                setRouteLayoutOptions(otherRouteLayoutOptions);

        }
    }

    public ComponentCreator<? extends WebRouteLayout, ? extends WebRouteLayoutOptions> getRouteLayoutCreator() {
        return routeLayoutCreator;
    }

    public S setRouteLayoutCreator(ComponentCreator<? extends WebBackendRouteLayout, ? extends WebBackendRouteLayoutOptions> routeLayoutCreator) {
        this.routeLayoutCreator = routeLayoutCreator;
        return self();
    }

    protected WebBackendRouteLayoutOptions createDefaultRouteLayoutOptions() {
        WebBackendRouteLayoutOptions options = ((WebBackendRouteLayoutOptions) (super.createDefaultRouteLayoutOptions()));
        return options;
    }
}
...
import dev.reuise.web.core.view.AbstractWebViewOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendViewOptions<S extends AbstractWebBackendViewOptions<S>> extends AbstractWebViewOptions<S> implements WebBackendViewOptions {
    ...
    protected AbstractWebBackendViewOptions() {
        this(null);
    }

    protected AbstractWebBackendViewOptions(WebBackendFlexContainerOptions baseOptions) {
    ...
    @Override
    public WebBackendView getComponent() {
        return ((WebBackendView) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendViewOptions) (other)) instanceof WebBackendViewOptions) {
            WebBackendViewOptions otherWebBackendViewOptions = ((WebBackendViewOptions) (other));
        }
    }
}
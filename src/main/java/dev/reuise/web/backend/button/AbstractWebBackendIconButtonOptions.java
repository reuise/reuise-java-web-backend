...
import dev.reuise.web.core.button.AbstractWebIconButtonOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendIconButtonOptions<S extends AbstractWebBackendIconButtonOptions<S>> extends AbstractWebIconButtonOptions<S> implements WebBackendIconButtonOptions {
    ...
    protected AbstractWebBackendIconButtonOptions() {
        this(null);
    }

    protected AbstractWebBackendIconButtonOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("button");
        setBaseStyleClass("reuise-iconbutton");
    ...
    @Override
    public WebBackendIconButton getComponent() {
        return ((WebBackendIconButton) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendIconButtonOptions) (other)) instanceof WebBackendIconButtonOptions) {
            WebBackendIconButtonOptions otherWebBackendIconButtonOptions = ((WebBackendIconButtonOptions) (other));
            CoreIconOptions otherIconOptions = otherWebBackendIconButtonOptions.getIconOptions();

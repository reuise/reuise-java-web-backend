...
import dev.reuise.web.core.button.AbstractWebButtonOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendButtonOptions<S extends AbstractWebBackendButtonOptions<S>> extends AbstractWebButtonOptions<S> implements WebBackendButtonOptions {
    ...
    protected AbstractWebBackendButtonOptions() {
        this(null);
    }

    protected AbstractWebBackendButtonOptions(WebBackendParentComponentOptions baseOptions) {
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("button");
        setBaseStyleClass("reuise-button");
        setStoreInElementOptions(new ArrayList(Arrays.asList("useHistoryApi")));
        return true;
    }
    ...
    @Override
    public WebBackendButton getComponent() {
        return ((WebBackendButton) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendButtonOptions) (other)) instanceof WebBackendButtonOptions) {
            WebBackendButtonOptions otherWebBackendButtonOptions = ((WebBackendButtonOptions) (other));
            CoreIconOptions otherStartIconOptions = otherWebBackendButtonOptions.getStartIconOptions();
            if (otherStartIconOptions != null)
                setStartIconOptions(otherStartIconOptions);

            CoreInlineTextOptions otherLabelContainerOptions = otherWebBackendButtonOptions.getLabelContainerOptions();
            if (otherLabelContainerOptions != null)
                setLabelContainerOptions(otherLabelContainerOptions);

            CoreIconOptions otherEndIconOptions = otherWebBackendButtonOptions.getEndIconOptions();

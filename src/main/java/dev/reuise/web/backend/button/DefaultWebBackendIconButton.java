...
import dev.reuise.web.core.button.DefaultWebIconButtonPart;
...
public abstract class DefaultWebBackendIconButton<S extends DefaultWebBackendIconButton<S, O>, O extends WebBackendIconButtonOptions> extends DefaultWebIconButtonPart<S, O> implements WebBackendComponentType<S, O> , WebBackendIconButton {
    ...
    protected DefaultWebBackendIconButton(O options) {
        super(options);
    ...
    @Override
    public WebBackendIcon getIcon() {
        return ((WebBackendIcon) (super.getIcon()));
    }
    ...
    public void writeTo(PrintWriter writer) {
        writeStartTag(writer, hasAttribute("href") ? "a" : "button", true);

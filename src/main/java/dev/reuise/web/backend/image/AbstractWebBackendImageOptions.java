...
import dev.reuise.web.core.image.AbstractWebImageOptions;
...
// Option: Debug - CORE
// Option: DebugId - CORE
public abstract class AbstractWebBackendImageOptions<S extends AbstractWebBackendImageOptions<S>> extends AbstractWebImageOptions<S> implements WebBackendImageOptions {
    ...
    protected AbstractWebBackendImageOptions() {
        this(null);
    }

    protected AbstractWebBackendImageOptions(WebBackendBaseComponentOptions baseOptions) {
        baseComponentPart = (baseOptions != null) ? baseOptions : getComponentFactory().createBaseComponentOptions();
    }
    ...
    public boolean onPreInitialize() {
        ...
        setTagName("img");
        setBaseStyleClass("reuise-image");
        return true;
    }
    ...
    @Override
    public WebBackendImage getComponent() {
        return ((WebBackendImage) (baseComponentPart.getComponent()));
    }

    @Override
    public void merge(CoreComponentOptions other) {
        baseComponentPart.merge(other);
        if (((WebBackendImageOptions) (other)) instanceof WebBackendImageOptions) {
            WebBackendImageOptions otherWebBackendImageOptions = ((WebBackendImageOptions) (other));
            CoreLinkOptions otherLinkOptions = otherWebBackendImageOptions.getLinkOptions();
